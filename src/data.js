...
export const UNIT_DEFINITIONS = Object.freeze({
  worker_drone_t1: {
    ...
    role: "worker",
    roleDescription: "Construction and close-range self-defense",
    tier: 1,
    radius: 6,
    maxHp: 70,
    maxEnergy: 690,
