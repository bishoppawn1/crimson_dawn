...
const FACTORY_UNIT_DEFINITIONS = Object.freeze({
  ...
  mobile_artillery: provisionalFactoryUnit({
    ...
    movementEnergyPerUnit: 0.06, minimumAttackRange: 120, attackRange: 400,
  ...
  mobile_artillery_t2: provisionalFactoryUnit({
    ...
    movementEnergyPerUnit: 0.055, minimumAttackRange: 140, attackRange: 480,
  ...
  mobile_artillery_t3: provisionalFactoryUnit({
    ...
    movementEnergyPerUnit: 0.05, minimumAttackRange: 160, attackRange: 560,
  ...
  hexapod_landship: provisionalFactoryUnit({
    ...
    roleDescription: "Walking battleship with three moving-fire siege cannons and four AA flak mounts",
    unitDomain: "experimental", tier: 3, radius: 60, spriteScale: 11 / 15,
    footprintHitbox: "feet", maxHp: 4200, maxEnergy: 7800,
    speed: 25, movementEnergyPerUnit: 0.16, minimumAttackRange: 80,
    attackRange: 460, attackDamage: 358,
    attackEnergy: 119, attackCooldown: 2.5, metalCost: 3000, productionTime: 72,
    ...
    weaponSystems: Object.freeze([
      Object.freeze({ id: "main", name: "Main Siege Cannon", targetLayer: "ground", minimumAttackRange: 80, attackRange: 460, attackDamage: 140, attackEnergy: 43, attackCooldown: 2.7 }),
      Object.freeze({ id: "port", name: "Port Cannon", targetLayer: "ground", minimumAttackRange: 80, attackRange: 420, attackDamage: 85, attackEnergy: 26, attackCooldown: 2.2 }),
      Object.freeze({ id: "starboard", name: "Starboard Cannon", targetLayer: "ground", minimumAttackRange: 80, attackRange: 420, attackDamage: 85, attackEnergy: 26, attackCooldown: 2.2 }),
      Object.freeze({
        id: "fore_port_flak", name: "Forward Port Flak", weaponRole: "flak",
        targetLayer: "air", attackRange: 285, attackDamage: 12, attackEnergy: 6,
        attackCooldown: 0.48, airDamageMultiplier: 2, projectileSpeed: 1100,
        minimumProjectileTravelTime: 0.06, projectileTracksTarget: true,
      }),
      Object.freeze({
        id: "fore_starboard_flak", name: "Forward Starboard Flak", weaponRole: "flak",
        targetLayer: "air", attackRange: 285, attackDamage: 12, attackEnergy: 6,
        attackCooldown: 0.48, airDamageMultiplier: 2, projectileSpeed: 1100,
        minimumProjectileTravelTime: 0.06, projectileTracksTarget: true,
      }),
      Object.freeze({
        id: "aft_port_flak", name: "Aft Port Flak", weaponRole: "flak",
        targetLayer: "air", attackRange: 285, attackDamage: 12, attackEnergy: 6,
        attackCooldown: 0.48, airDamageMultiplier: 2, projectileSpeed: 1100,
        minimumProjectileTravelTime: 0.06, projectileTracksTarget: true,
      }),
      Object.freeze({
        id: "aft_starboard_flak", name: "Aft Starboard Flak", weaponRole: "flak",
        targetLayer: "air", attackRange: 285, attackDamage: 12, attackEnergy: 6,
        attackCooldown: 0.48, airDamageMultiplier: 2, projectileSpeed: 1100,
        minimumProjectileTravelTime: 0.06, projectileTracksTarget: true,
      }),
...
const baseUnitDefinitions = {
  ...
  spawn_architect_t1: {
    name: "Tier 1 Spawn Architect",
    role: "worker",
    roleDescription: "Invulnerable phase-flight builder for Spawn Wars",
    unitDomain: "air",
    movementLayer: "air",
    tier: 1,
    radius: 8,
...
Object.assign(structureDefinitions, {
  ...
  spawn_experimental_pad: {
    name: "Experimental Spawn Platform",
    family: "spawn_pad",
    buildable: false,
    testerSpawnable: false,
    spawnWarsOnly: true,
  ...
  spawn_fortress_turret: {
    name: "Frontline Annihilator",
    family: "spawn_objective_turret",
    renderFamily: "sentry_turret",
    buildable: false,
    testerSpawnable: false,
    spawnWarsOnly: true,
    tier: 3,
    ...
    attackEnergy: 0,
    attackCooldown: 1.4,
    capacitorCapacity: 180,
    capacitorChargeRate: 1_000,
    metalCost: 0,
    metalValue: 1,
    buildTime: 0,
    visionRange: 800,
  ...
  spawn_command_hq: {
    name: "Spawn Command Core",
    family: "spawn_objective_hq",
    headquarters: true,
    buildable: false,
    testerSpawnable: false,
    spawnWarsOnly: true,
