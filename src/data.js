...
const FACTORY_UNIT_DEFINITIONS = Object.freeze({
  ...
  interceptor_t2: provisionalFactoryUnit({
    ...
    unitDomain: "air", tier: 2, radius: 9, maxHp: 105, maxEnergy: 900, speed: 180,
  ...
  interceptor_t3: provisionalFactoryUnit({
    ...
    unitDomain: "air", tier: 3, radius: 10, maxHp: 150, maxEnergy: 1260, speed: 200,
  ...
  gunship_t2: provisionalFactoryUnit({
    ...
    unitDomain: "air", tier: 2, radius: 12, maxHp: 205, maxEnergy: 1140, speed: 122,
  ...
  gunship_t3: provisionalFactoryUnit({
    ...
    unitDomain: "air", tier: 3, radius: 13, maxHp: 295, maxEnergy: 1560, speed: 135,
  ...
  bomber_t2: provisionalFactoryUnit({
    ...
    unitDomain: "air", tier: 2, radius: 13, maxHp: 170, maxEnergy: 1320, speed: 105,
  ...
  bomber_t3: provisionalFactoryUnit({
    ...
    unitDomain: "air", tier: 3, radius: 13, maxHp: 245, maxEnergy: 1800, speed: 116,
  ...
  energy_tender_t2: provisionalFactoryUnit({
    ...
    unitDomain: "air", tier: 2, radius: 11, maxHp: 130, maxEnergy: 3900, speed: 140,
  ...
  energy_tender_t3: provisionalFactoryUnit({
    ...
    unitDomain: "air", tier: 3, radius: 12, maxHp: 190, maxEnergy: 5700, speed: 155,
  ...
  zenith_doughnut: provisionalFactoryUnit({
    ...
    speed: 250, movementEnergyPerUnit: 0.14, attackRange: 0, attackDamage: 0,
...
const structureDefinitions = {
  ...
  mech_factory_t1: {
    ...
    productionRate: 1,
    tier: 1,
    production: ["worker_drone_t1", "scout_mech", "assault_mech", "skyguard_mech", "energy_carrier"],
    metalCost: 180,
    buildTime: 12,
  },
  mech_factory_t2: {
    ...
    productionRate: 1.25,
    tier: 2,
    production: ["worker_drone_t2", "scout_mech_t2", "assault_mech_t2", "skyguard_mech_t2", "energy_carrier_t2"],
    metalCost: 340,
    buildTime: 18,
  },
  mech_factory_t3: {
    ...
    productionRate: 1.5,
    tier: 3,
    production: ["worker_drone_t3", "scout_mech_t3", "assault_mech_t3", "skyguard_mech_t3", "energy_carrier_t3"],
    metalCost: 600,
    buildTime: 25,
  },
  supply_complex: {
