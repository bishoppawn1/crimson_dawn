...
const FACTORY_UNIT_DEFINITIONS = Object.freeze({
  ...
  radar_vehicle: provisionalFactoryUnit({
    ...
    roleDescription: "Mobile long-range radar with a light defensive cannon",
    ...
    metalCost: 125, productionTime: 9, supplyCost: 5,
  }),
  radar_vehicle_t2: provisionalFactoryUnit({
    name: "Tier 2 Pathfinder Radar", role: "radar_vehicle",
    roleDescription: "Mobile long-range radar with a defensive cannon",
    ...
    metalCost: 195, productionTime: 11, supplyCost: 8,
  }),
  radar_vehicle_t3: provisionalFactoryUnit({
    name: "Tier 3 Pathfinder Radar", role: "radar_vehicle",
    roleDescription: "Mobile long-range radar with an improved defensive cannon",
    ...
    metalCost: 290, productionTime: 14, supplyCost: 11,
  }),
  ...
  radar_aircraft_t2: provisionalFactoryUnit({
    ...
    roleDescription: "Fast airborne radar with a light defensive weapon",
    ...
    metalCost: 195, productionTime: 10, supplyCost: 7,
  }),
  radar_aircraft_t3: provisionalFactoryUnit({
    name: "Tier 3 Skywatch Radar", role: "radar_aircraft",
    roleDescription: "Fast airborne radar with an improved defensive weapon",
    ...
    metalCost: 295, productionTime: 13, supplyCost: 10,
  }),
...
const baseUnitDefinitions = {
  ...
  radar_mech: {
    ...
    role: "radar_mech",
    roleDescription: "Long-range radar scout with a light defensive weapon",
    tier: 1,
    radius: 9,
    maxHp: 125,
    maxEnergy: 720,
  ...
  radar_mech_t2: {
    ...
    role: "radar_mech",
    roleDescription: "Long-range radar scout with a defensive weapon",
    tier: 2,
    radius: 10,
    maxHp: 175,
    maxEnergy: 990,
  ...
  radar_mech_t3: {
    ...
    role: "radar_mech",
    roleDescription: "Long-range radar scout with an improved defensive weapon",
    tier: 3,
    radius: 11,
    maxHp: 240,
    maxEnergy: 1350,
...
Object.assign(structureDefinitions, {
  ...
  radar_tower_t3: {
    ...
    minimumWorkerTier: 3, radius: 38, footprint: [3, 3], maxHp: 760, powerDemand: 8,
  ...
  sentry_turret_t3: {
    ...
    minimumWorkerTier: 3, radius: 38, footprint: [3, 3], maxHp: 900, attackRange: 360,
  ...
  flak_turret_t3: {
    ...
    minimumWorkerTier: 3, radius: 38, footprint: [3, 3], maxHp: 690,
