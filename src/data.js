...
const FACTORY_UNIT_DEFINITIONS = Object.freeze({
  ...
  radar_vehicle: provisionalFactoryUnit({
    ...
    unitDomain: "vehicle", tier: 1, radius: 10, maxHp: 145, maxEnergy: 840, speed: 82,
  ...
  radar_vehicle_t2: provisionalFactoryUnit({
    ...
    unitDomain: "vehicle", tier: 2, radius: 11, maxHp: 205, maxEnergy: 1140, speed: 88,
  ...
  radar_vehicle_t3: provisionalFactoryUnit({
    ...
    unitDomain: "vehicle", tier: 3, radius: 12, maxHp: 285, maxEnergy: 1500, speed: 95,
  ...
  flak_crawler: provisionalFactoryUnit({
    ...
    unitDomain: "vehicle", tier: 1, radius: 10, maxHp: 150, maxEnergy: 720, speed: 76,
  ...
  flak_crawler_t2: provisionalFactoryUnit({
    ...
    roleDescription: "Mobile anti-air battery · 2× damage against aircraft",
    unitDomain: "vehicle", tier: 2, radius: 11, maxHp: 215, maxEnergy: 990, speed: 82,
  ...
  flak_crawler_t3: provisionalFactoryUnit({
    ...
    roleDescription: "Mobile anti-air battery · 2× damage against aircraft",
    unitDomain: "vehicle", tier: 3, radius: 12, maxHp: 300, maxEnergy: 1320, speed: 88,
  ...
  dropship_t1: provisionalFactoryUnit({
    name: "Tier 1 Dropship", role: "transport", roleDescription: "Air transport · carries 8 ground units",
    unitDomain: "air", tier: 1, radius: 13, maxHp: 170, maxEnergy: 1500, speed: 170,
    movementEnergyPerUnit: 0.09, attackRange: 0, attackDamage: 0, attackEnergy: 0,
    attackCooldown: 0, metalCost: 190, productionTime: 12, supplyCost: 8,
...
const structureDefinitions = {
  ...
  mech_factory_t1: {
    ...
    productionRate: 1,
    tier: 1,
    production: ["worker_drone_t1", "scout_mech", "assault_mech", "skyguard_mech", "energy_carrier", "radar_mech", "dropship_t1"],
    metalCost: 180,
    buildTime: 12,
  },
  mech_factory_t2: {
    ...
    productionRate: 1.25,
    tier: 2,
    production: ["worker_drone_t2", "scout_mech_t2", "assault_mech_t2", "skyguard_mech_t2", "energy_carrier_t2", "radar_mech_t2", "dropship_t2"],
    metalCost: 340,
    buildTime: 18,
  },
  mech_factory_t3: {
    ...
    productionRate: 1.5,
    tier: 3,
    production: ["worker_drone_t3", "scout_mech_t3", "assault_mech_t3", "skyguard_mech_t3", "energy_carrier_t3", "radar_mech_t3", "dropship_t3"],
    metalCost: 600,
    buildTime: 25,
  },
  supply_complex: {
...
Object.assign(structureDefinitions, {
  ...
  air_factory_t2: {
    ...
    production: ["interceptor_t2", "gunship_t2", "bomber_t2", "energy_tender_t2", "radar_aircraft_t2"],
    productionRate: 1.25,
  ...
  air_factory_t3: {
    ...
    production: ["interceptor_t3", "gunship_t3", "bomber_t3", "energy_tender_t3", "radar_aircraft_t3"],
    productionRate: 1.5,
