...
const structureDefinitions = {
  ...
  mech_factory_t1: {
    ...
    productionRate: 1,
    tier: 1,
    production: ["worker_drone_t1", "scout_mech", "assault_mech", "skyguard_mech", "energy_carrier", "dropship_t1"],
    metalCost: 180,
    buildTime: 12,
  },
  mech_factory_t2: {
    ...
    productionRate: 1.25,
    tier: 2,
    production: ["worker_drone_t2", "scout_mech_t2", "assault_mech_t2", "skyguard_mech_t2", "energy_carrier_t2", "dropship_t2"],
    metalCost: 340,
    buildTime: 18,
  },
  mech_factory_t3: {
    ...
    productionRate: 1.5,
    tier: 3,
    production: ["worker_drone_t3", "scout_mech_t3", "assault_mech_t3", "skyguard_mech_t3", "energy_carrier_t3", "dropship_t3"],
    metalCost: 600,
    buildTime: 25,
  },
  supply_complex: {
...
Object.assign(structureDefinitions, {
  vehicle_factory_t1: {
    ...
    production: ["scout_vehicle", "battle_tank", "mobile_artillery", "flak_crawler", "grid_tanker"],
    productionRate: 1,
  ...
  vehicle_factory_t2: {
    ...
    production: ["scout_vehicle_t2", "battle_tank_t2", "mobile_artillery_t2", "flak_crawler_t2", "grid_tanker_t2"],
    productionRate: 1.25,
  ...
  vehicle_factory_t3: {
    ...
    production: ["scout_vehicle_t3", "battle_tank_t3", "mobile_artillery_t3", "flak_crawler_t3", "grid_tanker_t3"],
    productionRate: 1.5,
