...
**Automated tests documented:** 330
...
### 113. multiple reclamation drones can harvest the same crystal scrap pile
...
### 114. partially loaded reclamation drones visit another crystal scrap pile before returning
...
### 115. a powered yard replaces a destroyed drone for free after a delay
...
### 116. combat units automatically attack hostile units that enter weapon range
...
### 117. worker drones have weak, short-range defensive weapons
...
### 118. worker drones do not target or retaliate while constructing
...
### 119. worker drones repair damaged friendly units and completed buildings with energy
...
### 120. idle worker drones automatically repair the nearest damaged friendly target
...
### 121. automatic worker repair respects its service radius and higher-priority orders
...
### 122. active construction takes priority over automatic worker repair
...
### 123. worker drones can repair one another but can never repair themselves
...
### 124. an active repair assignment takes priority over worker combat
...
### 125. combat units automatically attack hostile structures in weapon range
...
### 126. player and enemy units pursue the hostile aggressor that damages them
...
### 127. force-moving units do not abandon their order to retaliate
...
### 128. a moving unit stops to attack and resumes its route after the target is destroyed
...
### 129. a force move ignores enemies until the unit reaches its destination
...
### 130. power relay towers extend a generator network to distant structures
...
### 131. power coverage uses the same grid-aligned square cells as network connections
...
### 132. powered Crystal Harvesters generate crystal over time
...
### 133. bright Rich Crystal Deposits increase a harvester's actual crystal output
...
### 134. each mech factory tier offers improved copies of the same six unit roles
...
### 135. vehicle factories produce six matching-tier vehicle roles
...
### 136. air factories begin at Tier 2 and produce six matching-tier aircraft roles
...
### 137. all flying units use the faster movement profiles
...
### 138. Dropships begin at Tier 2 in Air Factories with eight ground-unit cargo slots
...
### 139. explicit transport orders reserve eight slots, board nearby units, and unload them
...
### 140. multi-transport filling balances reservations and rejects aircraft cargo
...
### 141. destroying a loaded Dropship destroys its passengers and snapshots preserve cargo
...
### 142. all units and structures provide a useful deterministic vision range
...
### 143. enemy contacts are hidden until they enter current friendly vision
...
### 144. powered radar arrays reveal long range and lose that coverage off-grid
...
### 145. radar towers and mobile radar units improve across every available branch tier
...
### 146. enemy AI invests in radar after preserving its opening wave and garrison
...
### 147. direct attack commands cannot target unseen enemies
...
### 148. vehicle and air factories only queue units from their own tier and branch
...
### 149. vehicle and air factories deploy their completed production orders
...
### 150. mech factories only queue the six unit variants matching their tier
...
### 151. matching factory groups route production to the shortest powered queue
...
### 152. repeated group production orders distribute across matching factories
...
### 153. group production skips unpowered factories and rejects mixed factory types
...
### 154. a Tier 1 mech factory spends crystal and constructs a worker drone
...
### 155. unit roles and tiers reserve different provisional supply amounts
...
### 156. production reserves supply and rejects orders beyond the massive base limit
...
### 157. a powered Strategic Supply Complex adds and upgrades massive supply capacity
...
### 158. the Strategic Supply Complex is larger than every production building
...
### 159. factories choose an unobstructed exit when the preferred spawn is blocked
...
### 160. factories do not deploy a completed unit on top of another unit
...
### 161. player and enemy factories spread repeated output across rally formations
...
### 162. setting a new factory rally point resets its formation slots
...
### 163. matching factories share an atomic grouped rally point and formation
...
### 164. grouped rally rejects mixed factory types and tiers without changing either
...
### 165. a completed unit waits in a surrounded factory until an exit opens
...
### 166. newly produced combat units engage threats while rallying
...
### 167. workers spend crystal and complete new structures
...
### 168. damage to an unfinished building persists through construction and completion
...
### 169. Shift-queued construction completes foundations in placement order
...
### 170. ordinary build orders replace queued construction and move orders clear it
...
### 171. cancelling construction removes it from worker queues and advances current work
...
### 172. powered sentry turrets automatically defend against nearby enemies
...
### 173. powered sentry turrets automatically attack hostile structures
...
### 174. a sentry capacitor charges from live generator output and fires without a grid battery
...
### 175. a relay-connected sentry capacitor accepts partial surplus generator output
...
### 176. full idle sentries do not prevent a new sentry from charging
...
### 177. workers can build and upgrade every Shield Turret tier
...
### 178. Shield Turret protection radii use the expanded balance values
...
### 179. Shield Turret upgrades retain existing strength and regenerate the added capacity
...
### 180. higher-tier Shield Turrets protect targets beyond the Tier 1 field
...
### 181. a powered Shield Turret absorbs hits inside its field and spills excess damage through
...
### 182. a powered Shield Turret protects its own structure
...
### 183. Shield Turrets do not intercept attacks outside their field or while unpowered
...
### 184. a damaged Shield Turret regenerates slowly by drawing local grid energy
...
### 185. destroyed reclamation drones drop their carried crystal scrap at the death location
...
### 186. both sides start with a Headquarters, three workers, a Tier 1 factory, a generator, and a powered Crystal Harvester
...
### 187. Crystal Harvesters can only be placed on unused crystal deposits and snap to them
...
### 188. energy-production buildings can be placed away from crystal deposits
...
### 189. units route around structures without crossing their collision footprint
...
### 190. a worker can leave the lane after completing a building beside another structure
...
### 191. workers can construct from a corner of a rectangular building footprint
...
### 192. a lower-tier worker cannot resume an advanced foundation
...
### 193. right-click build commands can resume an unfinished friendly structure
...
### 194. a replacement worker can finish a project after the original builder dies
...
### 195. a worker keeps its construction assignment through stasis and resumes after reactivation
...
### 196. construction placement rejects foundations that overlap existing buildings
...
### 197. buildings may occupy directly adjacent grid cells without invisible padding
...
### 198. friendly units vacate a construction site when its foundation is placed
...
### 199. construction placement still rejects sites occupied by hostile units
...
### 200. ordinary buildings snap to the shared 40-unit construction grid
...
### 201. odd and even building footprints align every edge to a grid line
...
### 202. building classes use distinct grid footprints
...
### 203. Tier 3 ordinary buildings retain their Tier 2 footprint and physical radius
...
### 204. Crystal Harvester footprints never exceed two grid cells per side
...
### 205. the Tier 2 Power Relay Tower stays compact and improves every relay function
...
### 206. enemy AI searches nearby grid cells when its preferred generator site is occupied
...
### 207. enemy AI construction avoids sites controlled by a superior hostile force
...
### 208. enemy AI remembers recently destroyed construction sites
...
### 209. enemy AI skips a contested deposit for a safer expansion
...
### 210. enemy AI requests generators instead of Grid Batteries at every energy level
...
### 211. enemy AI proactively maintains multiple paid Pulse Generators
...
### 212. enemy AI scales generator count and output headroom with its consumers
...
### 213. advanced AI economies add generators matching their operational tier
...
### 214. enemy AI waits for its pending generator without adding a Grid Battery
...
### 215. enemy AI requests flak when aircraft threaten its base
...
### 216. a stable AI builds vehicle and air production through each available tier
...
### 217. every AI commander independently requests its missing vehicle branch
...
### 218. a mature enemy economy deliberately progresses through Tier 2 and Tier 3 factories
...
### 219. advanced enemy mech factories produce the worker generation needed for the next tier
...
### 220. enemy AI builds at most one charger and only for depleted staged units
...
### 221. enemy AI routes depleted staged units into its charger and waits for recharge
...
### 222. the standard enemy opening establishes defenses and launches promptly
...
### 223. enemy AI builds generation before spending crystal on an unpowered consumer
...
### 224. enemy AI places a needed relay on its connected grid
...
### 225. enemy AI places powered consumers inside its energized grid
...
### 226. enemy AI completes extra generation before projected demand exceeds supply
...
### 227. enemy AI reassigns an idle worker to an abandoned foundation
...
### 228. enemy AI builds an initial combat force before reserving for expensive construction
...
### 229. enemy AI balances combat roles and adds energy support as its army grows
...
### 230. enemy AI never exceeds three mobile energy suppliers across all branches
...
### 231. enemy AI reserves crystal for its next generator after fielding a combat force
...
### 232. enemy AI only constructs a Supply Complex when its remaining supply is low
...
### 233. enemy AI establishes a paid outpost and expands to another crystal deposit
...
### 234. fortified opposition accelerates AI expansion beyond two harvesters
...
### 235. AI places each remote harvester sentry on its enemy-facing side
...
### 236. AI outpost garrisons stay out of attack waves and answer local threats
...
### 237. enemy AI expands beyond four harvesters when crystal is low and skips player claims
...
### 238. workers begin construction at the floating-point edge of build range
...
### 239. enemy combat units wait for a full wave before attacking
...
### 240. enemy AI does not count armed workers as an attack wave
...
### 241. enemy combat units fire at nearby workers while advancing
...
### 242. enemy AI holds an outmatched wave until enough attackers are staged
...
### 243. enemy AI chooses a safer target instead of attacking a defended position
...
### 244. an already dispatched AI assault does not turn around when defenses appear
...
### 245. enemy combat units immediately answer structures rushed near their base as a wave
...
### 246. enemy rush responses wait for a coordinated force instead of sending one unit
...
### 247. cancelling construction removes the foundation, clears workers, and refunds unbuilt crystal
...
### 248. a commander can destroy one completed building without a refund
...
### 249. destroying every enemy unit and building ends the match in victory
...
### 250. losing every player unit and building ends the match in defeat
...
### 253. multiplayer field tests disable the enemy commander AI
...
### 254. simulation snapshots restore a playable multiplayer client state
...
### 255. mixed human and AI matches continue until only one command team remains
...
### 256. multiplayer lobby codes are exactly ten uppercase letters and numbers
...
### 257. every player count offers multiple dense and selectable battlefield layouts
...
### 258. the three-player ancient ruins map is a dense ruin complex
...
### 259. an eight-player match gives every commander the standard starting package
...
### 260. match teams preserve per-AI difficulty and player-selected alliances
...
### 261. AI difficulty changes deterministic decision cadence and attack preparation
...
### 262. eliminated AI commanders stop running strategic decisions
...
### 263. allied commanders share vision, reject friendly fire, and win together
...
### 264. snapshots preserve AI difficulties and commander alliances
...
### 265. every AI commander makes decisions with independent state and resources
...
### 266. victory waits until every AI commander has been eliminated
...
### 267. snapshots preserve multi-AI teams, starts, maps, and decision state
...
### 268. tactical minimap crystal markers use bright fog-independent colors
...
### 269. mortar shells travel faster and keep tracking moving targets
...
### 270. enemy AI assigns spare workers to powered factory production
...
### 271. enemy AI adds shield coverage after establishing its core force
