...
**Automated tests documented:** 298
...
### 11. the interface and battlefield present the economy as crimson crystal
...
### 12. match setup exposes per-AI difficulty and team assignment controls
...
### 36. enemy AI structure upgrades keep its strategic crystal reserve
...
### 37. enemy AI does not upgrade existing Grid Batteries
...
### 38. enemy AI upgrades existing economy buildings after unlocking their tier
...
### 39. higher-tier Crystal Harvesters still snap to deposits
...
### 40. the standard battlefield uses the much larger map and separated starting bases
...
### 41. single-player map selection resolves every available battlefield
...
### 42. multiplayer ignores a manual map choice and resolves a random shared map
...
### 43. multiplayer snapshots preserve the host-selected map
...
### 44. both starting bases have sparse symmetrical walls with open central gates
...
### 45. impassable terrain rejects construction and redirects destinations inside it
...
### 46. queued move orders hand units through each waypoint in order
...
### 47. ordinary move orders replace queued waypoints
...
### 48. ground units route around impassable terrain without entering it
...
### 49. group movement staggers expensive path replans across simulation ticks
...
### 50. large formations cap visibility-path searches per simulation tick
...
### 51. formation movement accepts more than 200 units at once
...
### 52. dense expanded bases bound obstacle corners considered by each route search
...
### 53. ground units escape U-shaped terrain instead of dead-ending against the back wall
...
### 54. move orders placed on structures resolve to a reachable footprint edge
...
### 55. aircraft fly directly over terrain, starting walls, and structures
...
### 56. reclamation drones also route around impassable terrain
...
### 57. reclamation drones pathfind out of concave terrain instead of dead-ending
...
### 58. reclamation drones fly directly over starting walls
...
### 59. vehicles are larger than same-tier mechs and tanks are larger than scouts
...
### 60. higher-tier unit sprites grow and armed variants add visible hardpoints
...
### 61. Zenith Doughnuts are enormous and fast strategic aircraft
...
### 62. overlapping friendly and enemy units physically separate
...
### 63. unit separation exits after one pass when no units overlap
...
### 64. finished ticks remove destroyed entity tombstones from active collections
...
### 65. idle armies stagger automatic target scans after their initial acquisition
...
### 66. movement consumes energy and an exhausted unit enters stasis
...
### 67. stasis regenerates only to the reactivation threshold before control returns
...
### 68. active low-energy units passively regenerate an emergency reserve
...
### 69. emergency regeneration lets an energy-starved unit resume firing
...
### 70. every active unit slowly regenerates to 20 percent energy
...
### 71. attacking damages the target and spends the attacker's energy
...
### 72. heavy unit projectiles deal no damage before their visible impact
...
### 73. long-range projectile events remain visible until their delayed impact
...
### 74. ordinary weapons deal reduced damage to aircraft
...
### 75. dedicated anti-air units deal bonus damage to aircraft
...
### 76. flak turrets prioritize aircraft and apply their air damage bonus
...
### 77. Raiders are fast harassment units that deal bonus damage to structures
...
### 78. Raiders automatically prioritize exposed infrastructure
...
### 79. Overdrive is restricted by unit capability and consumes energy
...
### 80. a linked charger draws stored energy from a grid battery
...
### 81. the faster Induction Charger transfers its provisional maximum rate
...
### 82. the enlarged Induction Charger field reaches 260 world units
...
### 83. an Induction Charger charges every unit in its field simultaneously
...
### 84. all units receive the full charger rate when the grid can supply it
...
### 85. every unit type has the enlarged provisional energy capacity
...
### 86. a charger outside the generator network cannot charge units
...
### 87. generators continuously produce and retain a capped internal reserve
...
### 88. battery storage is capped by completed battery capacity
...
### 89. an isolated charged battery powers its local grid while discharging
...
### 90. Crystal Harvesters continuously consume their passive power demand
...
### 91. a charged relay keeps its local grid alive after its generator is destroyed
...
### 92. an active factory queue adds production demand and lowers net energy
...
### 93. destroying a battery removes its stored energy and capacity
...
### 94. an energy carrier automatically supplies allies without crossing its protected reserve
...
### 95. an energy carrier spends exactly the energy shared fairly with nearby units
...
### 96. every mobile energy supplier transfers its matching output rate
...
### 97. every mobile energy supplier carries a tier-improving defensive weapon
...
### 98. destroyed units create finite reclaimable wreckage
...
### 99. a powered salvage yard automatically returns wreck crystal
...
### 100. multiple reclamation drones can harvest the same crystal scrap pile
...
### 101. partially loaded reclamation drones visit another crystal scrap pile before returning
...
### 102. a powered yard replaces a destroyed drone for free after a delay
...
### 103. combat units automatically attack hostile units that enter weapon range
...
### 104. worker drones have weak, short-range defensive weapons
...
### 105. worker drones do not target or retaliate while constructing
...
### 106. worker drones repair damaged friendly units and completed buildings with energy
...
### 107. idle worker drones automatically repair the nearest damaged friendly target
...
### 108. automatic worker repair respects its service radius and higher-priority orders
...
### 109. active construction takes priority over automatic worker repair
...
### 110. worker drones can repair one another but can never repair themselves
...
### 111. an active repair assignment takes priority over worker combat
...
### 112. combat units automatically attack hostile structures in weapon range
...
### 113. player and enemy units pursue the hostile aggressor that damages them
...
### 114. force-moving units do not abandon their order to retaliate
...
### 115. a moving unit stops to attack and resumes its route after the target is destroyed
...
### 116. a force move ignores enemies until the unit reaches its destination
...
### 117. power relay towers extend a generator network to distant structures
...
### 118. power coverage uses the same grid-aligned square cells as network connections
...
### 119. powered Crystal Harvesters generate crystal over time
...
### 120. bright Rich Crystal Deposits increase a harvester's actual crystal output
...
### 121. each mech factory tier offers improved copies of the same six unit roles
...
### 122. vehicle factories produce six matching-tier vehicle roles
...
### 123. air factories begin at Tier 2 and produce six matching-tier aircraft roles
...
### 124. all flying units use the faster movement profiles
...
### 125. Dropships begin at Tier 2 in Air Factories with eight ground-unit cargo slots
...
### 126. explicit transport orders reserve eight slots, board nearby units, and unload them
...
### 127. multi-transport filling balances reservations and rejects aircraft cargo
...
### 128. destroying a loaded Dropship destroys its passengers and snapshots preserve cargo
...
### 129. all units and structures provide a useful deterministic vision range
...
### 130. enemy contacts are hidden until they enter current friendly vision
...
### 131. powered radar arrays reveal long range and lose that coverage off-grid
...
### 132. radar towers and mobile radar units improve across every available branch tier
...
### 133. enemy AI invests in radar after preserving its opening wave and garrison
...
### 134. direct attack commands cannot target unseen enemies
...
### 135. vehicle and air factories only queue units from their own tier and branch
...
### 136. vehicle and air factories deploy their completed production orders
...
### 137. mech factories only queue the six unit variants matching their tier
...
### 138. matching factory groups route production to the shortest powered queue
...
### 139. repeated group production orders distribute across matching factories
...
### 140. group production skips unpowered factories and rejects mixed factory types
...
### 141. a Tier 1 mech factory spends crystal and constructs a worker drone
...
### 142. unit roles and tiers reserve different provisional supply amounts
...
### 143. production reserves supply and rejects orders beyond the massive base limit
...
### 144. a powered Strategic Supply Complex adds and upgrades massive supply capacity
...
### 145. the Strategic Supply Complex is larger than every production building
...
### 146. factories choose an unobstructed exit when the preferred spawn is blocked
...
### 147. factories do not deploy a completed unit on top of another unit
...
### 148. player and enemy factories spread repeated output across rally formations
...
### 149. setting a new factory rally point resets its formation slots
...
### 150. matching factories share an atomic grouped rally point and formation
...
### 151. grouped rally rejects mixed factory types and tiers without changing either
...
### 152. a completed unit waits in a surrounded factory until an exit opens
...
### 153. newly produced combat units engage threats while rallying
...
### 154. workers spend crystal and complete new structures
...
### 155. damage to an unfinished building persists through construction and completion
...
### 156. Shift-queued construction completes foundations in placement order
...
### 157. ordinary build orders replace queued construction and move orders clear it
...
### 158. cancelling construction removes it from worker queues and advances current work
...
### 159. powered sentry turrets automatically defend against nearby enemies
...
### 160. powered sentry turrets automatically attack hostile structures
...
### 161. a sentry capacitor charges from live generator output and fires without a grid battery
...
### 162. a relay-connected sentry capacitor accepts partial surplus generator output
...
### 163. full idle sentries do not prevent a new sentry from charging
...
### 164. workers can build and upgrade every Shield Turret tier
...
### 165. Shield Turret protection radii use the expanded balance values
...
### 166. Shield Turret upgrades retain existing strength and regenerate the added capacity
...
### 167. higher-tier Shield Turrets protect targets beyond the Tier 1 field
...
### 168. a powered Shield Turret absorbs hits inside its field and spills excess damage through
...
### 169. a powered Shield Turret protects its own structure
...
### 170. Shield Turrets do not intercept attacks outside their field or while unpowered
...
### 171. a damaged Shield Turret regenerates slowly by drawing local grid energy
...
### 172. destroyed reclamation drones drop their carried crystal scrap at the death location
...
### 173. both sides start with a Headquarters, three workers, a Tier 1 factory, a generator, and a powered Crystal Harvester
...
### 174. Crystal Harvesters can only be placed on unused crystal deposits and snap to them
...
### 175. energy-production buildings can be placed away from crystal deposits
...
### 176. units route around structures without crossing their collision footprint
...
### 177. a worker can leave the lane after completing a building beside another structure
...
### 178. workers can construct from a corner of a rectangular building footprint
...
### 179. a lower-tier worker cannot resume an advanced foundation
...
### 180. right-click build commands can resume an unfinished friendly structure
...
### 181. a replacement worker can finish a project after the original builder dies
...
### 182. a worker keeps its construction assignment through stasis and resumes after reactivation
...
### 183. construction placement rejects foundations that overlap existing buildings
...
### 184. buildings may occupy directly adjacent grid cells without invisible padding
...
### 185. friendly units vacate a construction site when its foundation is placed
...
### 186. construction placement still rejects sites occupied by hostile units
...
### 187. ordinary buildings snap to the shared 40-unit construction grid
...
### 188. odd and even building footprints align every edge to a grid line
...
### 189. building classes use distinct grid footprints
...
### 190. Crystal Harvester footprints never exceed two grid cells per side
...
### 191. the Tier 2 Power Relay Tower stays compact and improves every relay function
...
### 192. enemy AI searches nearby grid cells when its preferred generator site is occupied
...
### 193. enemy AI construction avoids sites controlled by a superior hostile force
...
### 194. enemy AI remembers recently destroyed construction sites
...
### 195. enemy AI skips a contested deposit for a safer expansion
...
### 196. enemy AI requests generators instead of Grid Batteries at every energy level
...
### 197. enemy AI proactively maintains multiple paid Pulse Generators
...
### 198. enemy AI scales generator count and output headroom with its consumers
...
### 199. advanced AI economies add generators matching their operational tier
...
### 200. enemy AI waits for its pending generator without adding a Grid Battery
...
### 201. enemy AI requests flak when aircraft threaten its base
...
### 202. a stable AI builds vehicle and air production through each available tier
...
### 203. every AI commander independently requests its missing vehicle branch
...
### 204. a mature enemy economy deliberately progresses through Tier 2 and Tier 3 factories
...
### 205. advanced enemy mech factories produce the worker generation needed for the next tier
...
### 206. enemy AI builds at most one charger and only for depleted staged units
...
### 207. enemy AI routes depleted staged units into its charger and waits for recharge
...
### 208. the standard enemy opening establishes defenses and launches promptly
...
### 209. enemy AI builds generation before spending crystal on an unpowered consumer
...
### 210. enemy AI places a needed relay on its connected grid
...
### 211. enemy AI places powered consumers inside its energized grid
...
### 212. enemy AI completes extra generation before projected demand exceeds supply
...
### 213. enemy AI reassigns an idle worker to an abandoned foundation
...
### 214. enemy AI builds an initial combat force before reserving for expensive construction
...
### 215. enemy AI balances combat roles and adds energy support as its army grows
...
### 216. enemy AI never exceeds three mobile energy suppliers across all branches
...
### 217. enemy AI reserves crystal for its next generator after fielding a combat force
...
### 218. enemy AI only constructs a Supply Complex when its remaining supply is low
...
### 219. enemy AI establishes a paid outpost and expands to another crystal deposit
...
### 220. fortified opposition accelerates AI expansion beyond two harvesters
...
### 221. AI strategy requests a sentry at every undefended remote harvester
...
### 222. AI outpost garrisons stay out of attack waves and answer local threats
...
### 223. enemy AI expands beyond four harvesters when crystal is low and skips player claims
...
### 224. workers begin construction at the floating-point edge of build range
...
### 225. enemy combat units wait for a full wave before attacking
...
### 226. enemy AI does not count armed workers as an attack wave
...
### 227. enemy combat units fire at nearby workers while advancing
...
### 228. enemy AI holds an outmatched wave until enough attackers are staged
...
### 229. enemy AI chooses a safer target instead of attacking a defended position
...
### 230. an already dispatched AI assault does not turn around when defenses appear
...
### 231. enemy combat units immediately answer structures rushed near their base as a wave
...
### 232. enemy rush responses wait for a coordinated force instead of sending one unit
...
### 233. cancelling construction removes the foundation, clears workers, and refunds unbuilt crystal
...
### 234. destroying every enemy unit and building ends the match in victory
...
### 235. losing every player unit and building ends the match in defeat
...
### 236. destroying a Headquarters instantly eliminates all of that commander's assets
...
### 237. field tests enable elimination while isolated simulations remain opt-in
...
### 238. multiplayer field tests disable the enemy commander AI
...
### 239. simulation snapshots restore a playable multiplayer client state
...
### 240. mixed human and AI matches continue until only one command team remains
...
### 241. multiplayer lobby codes are exactly ten uppercase letters and numbers
...
### 242. every player count offers multiple dense and selectable battlefield layouts
...
### 243. the three-player ancient ruins map is a dense ruin complex
...
### 244. an eight-player match gives every commander the standard starting package
...
### 245. match teams preserve per-AI difficulty and player-selected alliances
...
### 246. AI difficulty changes deterministic decision cadence and attack preparation
...
### 247. eliminated AI commanders stop running strategic decisions
...
### 248. allied commanders share vision, reject friendly fire, and win together
...
### 249. snapshots preserve AI difficulties and commander alliances
...
### 250. every AI commander makes decisions with independent state and resources
...
### 251. victory waits until every AI commander has been eliminated
...
### 252. snapshots preserve multi-AI teams, starts, maps, and decision state
...
### 253. tactical minimap crystal markers use bright fog-independent colors
...
### 254. mortar shells travel faster and keep tracking moving targets
