...
**Automated tests documented:** 294
...
### 64. movement consumes energy and an exhausted unit enters stasis
...
### 65. stasis regenerates only to the reactivation threshold before control returns
...
### 66. active low-energy units passively regenerate an emergency reserve
...
### 67. emergency regeneration lets an energy-starved unit resume firing
...
### 68. every active unit slowly regenerates to 20 percent energy
...
### 69. attacking damages the target and spends the attacker's energy
...
### 70. heavy unit projectiles deal no damage before their visible impact
...
### 71. long-range projectile events remain visible until their delayed impact
...
### 72. ordinary weapons deal reduced damage to aircraft
...
### 73. dedicated anti-air units deal bonus damage to aircraft
...
### 74. flak turrets prioritize aircraft and apply their air damage bonus
...
### 75. Raiders are fast harassment units that deal bonus damage to structures
...
### 76. Raiders automatically prioritize exposed infrastructure
...
### 77. Overdrive is restricted by unit capability and consumes energy
...
### 78. a linked charger draws stored energy from a grid battery
...
### 79. the faster Induction Charger transfers its provisional maximum rate
...
### 80. the enlarged Induction Charger field reaches 260 world units
...
### 81. an Induction Charger charges every unit in its field simultaneously
...
### 82. all units receive the full charger rate when the grid can supply it
...
### 83. every unit type has the enlarged provisional energy capacity
...
### 84. a charger outside the generator network cannot charge units
...
### 85. generators continuously produce and retain a capped internal reserve
...
### 86. battery storage is capped by completed battery capacity
...
### 87. an isolated charged battery powers its local grid while discharging
...
### 88. Crystal Harvesters continuously consume their passive power demand
...
### 89. a charged relay keeps its local grid alive after its generator is destroyed
...
### 90. an active factory queue adds production demand and lowers net energy
...
### 91. destroying a battery removes its stored energy and capacity
...
### 92. an energy carrier automatically supplies allies without crossing its protected reserve
...
### 93. an energy carrier spends exactly the energy shared fairly with nearby units
...
### 94. every mobile energy supplier transfers its matching output rate
...
### 95. every mobile energy supplier carries a tier-improving defensive weapon
...
### 96. destroyed units create finite reclaimable wreckage
...
### 97. a powered salvage yard automatically returns wreck crystal
...
### 98. multiple reclamation drones can harvest the same crystal scrap pile
...
### 99. partially loaded reclamation drones visit another crystal scrap pile before returning
...
### 100. a powered yard replaces a destroyed drone for free after a delay
...
### 101. combat units automatically attack hostile units that enter weapon range
...
### 102. worker drones have weak, short-range defensive weapons
...
### 103. worker drones do not target or retaliate while constructing
...
### 104. worker drones repair damaged friendly units and completed buildings with energy
...
### 105. idle worker drones automatically repair the nearest damaged friendly target
...
### 106. automatic worker repair respects its service radius and higher-priority orders
...
### 107. active construction takes priority over automatic worker repair
...
### 108. worker drones can repair one another but can never repair themselves
...
### 109. an active repair assignment takes priority over worker combat
...
### 110. combat units automatically attack hostile structures in weapon range
...
### 111. player and enemy units pursue the hostile aggressor that damages them
...
### 112. force-moving units do not abandon their order to retaliate
...
### 113. a moving unit stops to attack and resumes its route after the target is destroyed
...
### 114. a force move ignores enemies until the unit reaches its destination
...
### 115. power relay towers extend a generator network to distant structures
...
### 116. power coverage uses the same grid-aligned square cells as network connections
...
### 117. powered Crystal Harvesters generate crystal over time
...
### 118. bright Rich Crystal Deposits increase a harvester's actual crystal output
...
### 119. each mech factory tier offers improved copies of the same six unit roles
...
### 120. vehicle factories produce six matching-tier vehicle roles
...
### 121. air factories begin at Tier 2 and produce six matching-tier aircraft roles
...
### 122. all flying units use the faster movement profiles
...
### 123. Dropships begin at Tier 2 in Air Factories with eight ground-unit cargo slots
...
### 124. explicit transport orders reserve eight slots, board nearby units, and unload them
...
### 125. multi-transport filling balances reservations and rejects aircraft cargo
...
### 126. destroying a loaded Dropship destroys its passengers and snapshots preserve cargo
...
### 127. all units and structures provide a useful deterministic vision range
...
### 128. enemy contacts are hidden until they enter current friendly vision
...
### 129. powered radar arrays reveal long range and lose that coverage off-grid
...
### 130. radar towers and mobile radar units improve across every available branch tier
...
### 131. enemy AI invests in radar after preserving its opening wave and garrison
...
### 132. direct attack commands cannot target unseen enemies
...
### 133. vehicle and air factories only queue units from their own tier and branch
...
### 134. vehicle and air factories deploy their completed production orders
...
### 135. mech factories only queue the six unit variants matching their tier
...
### 136. matching factory groups route production to the shortest powered queue
...
### 137. repeated group production orders distribute across matching factories
...
### 138. group production skips unpowered factories and rejects mixed factory types
...
### 139. a Tier 1 mech factory spends crystal and constructs a worker drone
...
### 140. unit roles and tiers reserve different provisional supply amounts
...
### 141. production reserves supply and rejects orders beyond the massive base limit
...
### 142. a powered Strategic Supply Complex adds and upgrades massive supply capacity
...
### 143. the Strategic Supply Complex is larger than every production building
...
### 144. factories choose an unobstructed exit when the preferred spawn is blocked
...
### 145. factories do not deploy a completed unit on top of another unit
...
### 146. player and enemy factories spread repeated output across rally formations
...
### 147. setting a new factory rally point resets its formation slots
...
### 148. matching factories share an atomic grouped rally point and formation
...
### 149. grouped rally rejects mixed factory types and tiers without changing either
...
### 150. a completed unit waits in a surrounded factory until an exit opens
...
### 151. newly produced combat units engage threats while rallying
...
### 152. workers spend crystal and complete new structures
...
### 153. damage to an unfinished building persists through construction and completion
...
### 154. Shift-queued construction completes foundations in placement order
...
### 155. ordinary build orders replace queued construction and move orders clear it
...
### 156. cancelling construction removes it from worker queues and advances current work
...
### 157. powered sentry turrets automatically defend against nearby enemies
...
### 158. powered sentry turrets automatically attack hostile structures
...
### 159. a sentry capacitor charges from live generator output and fires without a grid battery
...
### 160. a relay-connected sentry capacitor accepts partial surplus generator output
...
### 161. full idle sentries do not prevent a new sentry from charging
...
### 162. workers can build and upgrade every Shield Turret tier
...
### 163. Shield Turret protection radii use the expanded balance values
...
### 164. Shield Turret upgrades retain existing strength and regenerate the added capacity
...
### 165. higher-tier Shield Turrets protect targets beyond the Tier 1 field
...
### 166. a powered Shield Turret absorbs hits inside its field and spills excess damage through
...
### 167. a powered Shield Turret protects its own structure
...
### 168. Shield Turrets do not intercept attacks outside their field or while unpowered
...
### 169. a damaged Shield Turret regenerates slowly by drawing local grid energy
...
### 170. destroyed reclamation drones drop their carried crystal scrap at the death location
...
### 171. both sides start with a Headquarters, three workers, a Tier 1 factory, a generator, and a powered Crystal Harvester
...
### 172. Crystal Harvesters can only be placed on unused crystal deposits and snap to them
...
### 173. energy-production buildings can be placed away from crystal deposits
...
### 174. units route around structures without crossing their collision footprint
...
### 175. a worker can leave the lane after completing a building beside another structure
...
### 176. workers can construct from a corner of a rectangular building footprint
...
### 177. a lower-tier worker cannot resume an advanced foundation
...
### 178. right-click build commands can resume an unfinished friendly structure
...
### 179. a replacement worker can finish a project after the original builder dies
...
### 180. a worker keeps its construction assignment through stasis and resumes after reactivation
...
### 181. construction placement rejects foundations that overlap existing buildings
...
### 182. buildings may occupy directly adjacent grid cells without invisible padding
...
### 183. friendly units vacate a construction site when its foundation is placed
...
### 184. construction placement still rejects sites occupied by hostile units
...
### 185. ordinary buildings snap to the shared 40-unit construction grid
...
### 186. odd and even building footprints align every edge to a grid line
...
### 187. building classes use distinct grid footprints
...
### 188. Crystal Harvester footprints never exceed two grid cells per side
...
### 189. the Tier 2 Power Relay Tower stays compact and improves every relay function
...
### 190. enemy AI searches nearby grid cells when its preferred generator site is occupied
...
### 191. enemy AI construction avoids sites controlled by a superior hostile force
...
### 192. enemy AI remembers recently destroyed construction sites
...
### 193. enemy AI skips a contested deposit for a safer expansion
...
### 194. enemy AI requests generators instead of Grid Batteries at every energy level
...
### 195. enemy AI proactively maintains multiple paid Pulse Generators
...
### 196. enemy AI scales generator count and output headroom with its consumers
...
### 197. advanced AI economies add generators matching their operational tier
...
### 198. enemy AI waits for its pending generator without adding a Grid Battery
...
### 199. enemy AI requests flak when aircraft threaten its base
...
### 200. a stable AI builds vehicle and air production through each available tier
...
### 201. every AI commander independently requests its missing vehicle branch
...
### 202. a mature enemy economy deliberately progresses through Tier 2 and Tier 3 factories
...
### 203. advanced enemy mech factories produce the worker generation needed for the next tier
...
### 204. enemy AI builds at most one charger and only for depleted staged units
...
### 205. enemy AI routes depleted staged units into its charger and waits for recharge
...
### 206. the standard enemy opening establishes defenses and launches promptly
...
### 207. enemy AI builds generation before spending crystal on an unpowered consumer
...
### 208. enemy AI places a needed relay on its connected grid
...
### 209. enemy AI places powered consumers inside its energized grid
...
### 210. enemy AI completes extra generation before projected demand exceeds supply
...
### 211. enemy AI reassigns an idle worker to an abandoned foundation
...
### 212. enemy AI builds an initial combat force before reserving for expensive construction
...
### 213. enemy AI balances combat roles and adds energy support as its army grows
...
### 214. enemy AI never exceeds three mobile energy suppliers across all branches
...
### 215. enemy AI reserves crystal for its next generator after fielding a combat force
...
### 216. enemy AI only constructs a Supply Complex when its remaining supply is low
...
### 217. enemy AI establishes a paid outpost and expands to another crystal deposit
...
### 218. fortified opposition accelerates AI expansion beyond two harvesters
...
### 219. AI strategy requests a sentry at every undefended remote harvester
...
### 220. AI outpost garrisons stay out of attack waves and answer local threats
...
### 221. enemy AI expands beyond four harvesters when crystal is low and skips player claims
...
### 222. workers begin construction at the floating-point edge of build range
...
### 223. enemy combat units wait for a full wave before attacking
...
### 224. enemy AI does not count armed workers as an attack wave
...
### 225. enemy combat units fire at nearby workers while advancing
...
### 226. enemy AI holds an outmatched wave until enough attackers are staged
...
### 227. enemy AI chooses a safer target instead of attacking a defended position
...
### 228. an already dispatched AI assault does not turn around when defenses appear
...
### 229. enemy combat units immediately answer structures rushed near their base as a wave
...
### 230. enemy rush responses wait for a coordinated force instead of sending one unit
...
### 231. cancelling construction removes the foundation, clears workers, and refunds unbuilt crystal
...
### 232. destroying every enemy unit and building ends the match in victory
...
### 233. losing every player unit and building ends the match in defeat
...
### 234. destroying a Headquarters instantly eliminates all of that commander's assets
...
### 235. field tests enable elimination while isolated simulations remain opt-in
...
### 236. multiplayer field tests disable the enemy commander AI
...
### 237. simulation snapshots restore a playable multiplayer client state
...
### 238. mixed human and AI matches continue until only one command team remains
...
### 239. multiplayer lobby codes are exactly ten uppercase letters and numbers
...
### 240. every player count offers multiple dense and selectable battlefield layouts
...
### 241. the three-player ancient ruins map is a dense ruin complex
...
### 242. an eight-player match gives every commander the standard starting package
...
### 243. match teams preserve per-AI difficulty and player-selected alliances
...
### 244. AI difficulty changes deterministic decision cadence and attack preparation
...
### 245. allied commanders share vision, reject friendly fire, and win together
...
### 246. snapshots preserve AI difficulties and commander alliances
...
### 247. every AI commander makes decisions with independent state and resources
...
### 248. victory waits until every AI commander has been eliminated
...
### 249. snapshots preserve multi-AI teams, starts, maps, and decision state
...
### 250. tactical minimap crystal markers use bright fog-independent colors
...
### 251. mortar shells travel faster and keep tracking moving targets
