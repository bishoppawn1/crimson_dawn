...
**Automated tests documented:** 346
...
### 12. the Zenith Doughnut renderer shows two dorsal anti-air batteries
...
### 13. higher-tier armed sprites render their data-driven weapon attachments
...
### 14. right-clicking an active friendly factory sends selected workers to assist production
...
### 15. worker controls upgrade one tier and keep only one construction tier open
...
### 16. selected completed buildings expose an authorized destroy command
...
### 17. the interface and battlefield present the economy as crimson crystal
...
### 18. production controls disclose ground damage penalties
...
### 19. unit selection is concise and uses one compact shared construction queue
...
### 20. match setup exposes per-AI difficulty and team assignment controls
...
### 9. Tier 3 workers unlock the nuclear launcher and 2x2 anti-nuke turret
...
### 10. nuclear launchers construct one paid missile at a time and pause without power
...
### 11. nuclear missiles fly for exactly ten seconds and damage every team in three bands
...
### 12. powered anti-nuke turrets protect a 30x30-cell area and preserve interception vision
...
### 13. a nuclear missile grants its launching alliance short-range moving vision
...
### 14. nuclear missile and launcher readiness survive multiplayer snapshots
...
### 15. unit tester advantages apply only to the designated human team
...
### 16. unit tester construction completes immediately while AI construction stays normal
...
### 17. unit tester factory orders deploy on the next simulation step without spending crystal
...
### 18. unit tester team rules survive simulation snapshots
...
### 19. unit tester can instantly place completed buildings for an AI without funding it
...
### 20. unit tester can place collision-safe AI units that retain ordinary ownership
...
### 21. enemy spawning is unavailable outside Unit Tester and cannot target the tester team
...
### 22. construction authorization is enforced by the simulation
...
### 23. production-building branches expose their requested tiers
...
### 24. experimental factory exposes three distinct strategic units
...
### 25. experimental factory accepts paid production orders
...
### 26. hexapod landship strides through structures but still respects terrain
...
### 27. hexapod landship shells deal damage on impact instead of before firing
...
### 28. hexapod landship fires its independent weapons while moving
...
### 29. Zenith Doughnut stops before firing its ground beam
...
### 30. Zenith Doughnut beam pursuit only auto-acquires nearby ground targets
...
### 31. Zenith Doughnut AA batteries independently fire on aircraft during ground-beam attacks
...
### 32. explicit Zenith Doughnut anti-air orders pursue aircraft into battery range
...
### 33. Zenith Doughnuts hover directly over a locally acquired target
...
### 34. explicit orders take priority over automatic Zenith pursuit
...
### 35. airborne Zenith Doughnuts do not push ground units out of their beam
...
### 36. higher-tier building variants retain their family behavior
...
### 37. every higher-tier infrastructure building improves its defining function
...
### 38. higher-tier sentries deal more damage and reach targets that Tier 1 cannot
...
### 39. sentry turrets use the strengthened weapon profiles
...
### 40. mortar turrets enforce minimum and maximum range
...
### 41. workers can build and upgrade every mortar turret tier
...
### 42. higher-tier factories have progressively faster production throughput
...
### 43. workers provide reduced tier-specific factory assistance at an added grid cost
...
### 44. worker assistance power draw increases one percentage point per worker
...
### 45. factory production pauses when its grid cannot cover worker assistance demand
...
### 46. production assistance requires an active friendly factory and overrides worker combat
...
### 47. completed mech factories globally unlock matching structure upgrades
...
### 48. structure upgrade unlocks are team-specific and expanded footprints need clear space
...
### 49. selected workers upgrade only one tier while preserving their active state
...
### 50. enemy AI structure upgrades keep its strategic crystal reserve
...
### 51. enemy AI does not upgrade existing Grid Batteries
...
### 52. enemy AI upgrades existing economy buildings after unlocking their tier
...
### 53. enemy AI purchases an eligible upgrade before routine production consumes its surplus
...
### 54. higher-tier Crystal Harvesters still snap to deposits
...
### 55. the standard battlefield uses the much larger map and separated starting bases
...
### 56. single-player map selection resolves every available battlefield
...
### 57. multiplayer ignores a manual map choice and resolves a random shared map
...
### 58. multiplayer snapshots preserve the host-selected map
...
### 59. both starting bases have sparse symmetrical walls with open central gates
...
### 60. impassable terrain rejects construction and redirects destinations inside it
...
### 61. queued move orders hand units through each waypoint in order
...
### 62. patrol orders repeat every recorded point and survive snapshots
...
### 63. patrol requires two points and explicit movement commands cancel it
...
### 64. ordinary move orders replace queued waypoints
...
### 65. ground units route around impassable terrain without entering it
...
### 66. ground units relocate out of a structure pocket when no route remains
...
### 67. group movement staggers expensive path replans across simulation ticks
...
### 68. large formations cap visibility-path searches per simulation tick
...
### 69. formation movement accepts more than 200 units at once
...
### 70. dense expanded bases bound obstacle corners considered by each route search
...
### 71. ground units escape U-shaped terrain instead of dead-ending against the back wall
...
### 72. move orders placed on structures resolve to a reachable footprint edge
...
### 73. aircraft fly directly over terrain, starting walls, and structures
...
### 74. reclamation drones also route around impassable terrain
...
### 75. reclamation drones pathfind out of concave terrain instead of dead-ending
...
### 76. reclamation drones fly directly over starting walls
...
### 77. vehicles are larger than same-tier mechs and tanks are larger than scouts
...
### 78. higher-tier unit sprites grow and armed variants add visible hardpoints
...
### 79. Zenith Doughnuts are enormous and fast strategic aircraft
...
### 80. overlapping friendly and enemy units physically separate
...
### 81. unit separation exits after one pass when no units overlap
...
### 82. finished ticks remove destroyed entity tombstones from active collections
...
### 83. idle armies stagger automatic target scans after their initial acquisition
...
### 84. movement consumes energy and an exhausted unit enters stasis
...
### 85. stasis regenerates only to the reactivation threshold before control returns
...
### 86. active low-energy units passively regenerate an emergency reserve
...
### 87. emergency regeneration lets an energy-starved unit resume firing
...
### 88. every active unit slowly regenerates to 20 percent energy
...
### 89. attacking damages the target and spends the attacker's energy
...
### 90. heavy unit projectiles deal no damage before their visible impact
...
### 91. mobile artillery trades a close-range dead zone for long-range fire
...
### 92. long-range projectile events remain visible until their delayed impact
...
### 93. ordinary weapons deal reduced damage to aircraft
...
### 94. Interceptors prioritize aircraft and trade ground damage for air superiority
...
### 95. dedicated anti-air units deal bonus damage to aircraft
...
### 96. flak turrets prioritize aircraft and apply their air damage bonus
...
### 97. Raiders are fast harassment units that deal bonus damage to structures
...
### 98. Raiders automatically prioritize exposed infrastructure
...
### 156. the Tier 3 Overseer Spire exposes five Tier 1 radar-sized orbital zones
