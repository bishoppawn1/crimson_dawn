...
**Automated tests documented:** 286
...
### 8. right-clicking an active friendly factory sends selected workers to assist production
...
### 9. the interface and battlefield present the economy as crimson crystal
...
### 10. match setup exposes per-AI difficulty and team assignment controls
...
### 58. overlapping friendly and enemy units physically separate
...
### 59. unit separation exits after one pass when no units overlap
...
### 60. movement consumes energy and an exhausted unit enters stasis
...
### 61. stasis regenerates only to the reactivation threshold before control returns
...
### 62. active low-energy units passively regenerate an emergency reserve
...
### 63. emergency regeneration lets an energy-starved unit resume firing
...
### 64. every active unit slowly regenerates to 20 percent energy
...
### 65. attacking damages the target and spends the attacker's energy
...
### 66. heavy unit projectiles deal no damage before their visible impact
...
### 67. long-range projectile events remain visible until their delayed impact
...
### 68. ordinary weapons deal reduced damage to aircraft
...
### 69. dedicated anti-air units deal bonus damage to aircraft
...
### 70. flak turrets prioritize aircraft and apply their air damage bonus
...
### 71. Raiders are fast harassment units that deal bonus damage to structures
...
### 72. Raiders automatically prioritize exposed infrastructure
...
### 73. Overdrive is restricted by unit capability and consumes energy
...
### 74. a linked charger draws stored energy from a grid battery
...
### 75. the faster Induction Charger transfers its provisional maximum rate
...
### 76. the enlarged Induction Charger field reaches 260 world units
...
### 77. an Induction Charger charges every unit in its field simultaneously
...
### 78. all units receive the full charger rate when the grid can supply it
...
### 79. every unit type has the enlarged provisional energy capacity
...
### 80. a charger outside the generator network cannot charge units
...
### 81. generators continuously produce and retain a capped internal reserve
...
### 82. battery storage is capped by completed battery capacity
...
### 83. an isolated charged battery powers its local grid while discharging
...
### 84. Crystal Harvesters continuously consume their passive power demand
...
### 85. a charged relay keeps its local grid alive after its generator is destroyed
...
### 86. an active factory queue adds production demand and lowers net energy
...
### 87. destroying a battery removes its stored energy and capacity
...
### 88. an energy carrier automatically supplies allies without crossing its protected reserve
...
### 89. an energy carrier spends exactly the energy shared fairly with nearby units
...
### 90. every mobile energy supplier transfers its matching output rate
...
### 91. destroyed units create finite reclaimable wreckage
...
### 92. a powered salvage yard automatically returns wreck crystal
...
### 93. multiple reclamation drones can harvest the same crystal scrap pile
...
### 94. partially loaded reclamation drones visit another crystal scrap pile before returning
...
### 95. a powered yard replaces a destroyed drone for free after a delay
...
### 96. combat units automatically attack hostile units that enter weapon range
...
### 97. worker drones have weak, short-range defensive weapons
...
### 98. worker drones do not target or retaliate while constructing
...
### 99. worker drones repair damaged friendly units and completed buildings with energy
...
### 100. idle worker drones automatically repair the nearest damaged friendly target
...
### 101. automatic worker repair respects its service radius and higher-priority orders
...
### 102. active construction takes priority over automatic worker repair
...
### 103. worker drones can repair one another but can never repair themselves
...
### 104. an active repair assignment takes priority over worker combat
...
### 105. combat units automatically attack hostile structures in weapon range
...
### 106. player and enemy units pursue the hostile aggressor that damages them
...
### 107. force-moving units do not abandon their order to retaliate
...
### 108. a moving unit stops to attack and resumes its route after the target is destroyed
...
### 109. a force move ignores enemies until the unit reaches its destination
...
### 110. power relay towers extend a generator network to distant structures
...
### 111. power coverage uses the same grid-aligned square cells as network connections
...
### 112. powered Crystal Harvesters generate crystal over time
...
### 113. bright Rich Crystal Deposits increase a harvester's actual crystal output
...
### 114. each mech factory tier offers improved copies of the same six unit roles
...
### 115. vehicle factories produce six matching-tier vehicle roles
...
### 116. air factories begin at Tier 2 and produce six matching-tier aircraft roles
...
### 117. all flying units use the faster movement profiles
...
### 118. Dropships begin at Tier 2 in Air Factories with eight ground-unit cargo slots
...
### 119. explicit transport orders reserve eight slots, board nearby units, and unload them
...
### 120. multi-transport filling balances reservations and rejects aircraft cargo
...
### 121. destroying a loaded Dropship destroys its passengers and snapshots preserve cargo
...
### 122. all units and structures provide a useful deterministic vision range
...
### 123. enemy contacts are hidden until they enter current friendly vision
...
### 124. powered radar arrays reveal long range and lose that coverage off-grid
...
### 125. radar towers and mobile radar units improve across every available branch tier
...
### 126. enemy AI invests in radar after preserving its opening wave and garrison
...
### 127. direct attack commands cannot target unseen enemies
...
### 128. vehicle and air factories only queue units from their own tier and branch
...
### 129. vehicle and air factories deploy their completed production orders
...
### 130. mech factories only queue the six unit variants matching their tier
...
### 131. matching factory groups route production to the shortest powered queue
...
### 132. repeated group production orders distribute across matching factories
...
### 133. group production skips unpowered factories and rejects mixed factory types
...
### 134. a Tier 1 mech factory spends crystal and constructs a worker drone
...
### 135. unit roles and tiers reserve different provisional supply amounts
...
### 136. production reserves supply and rejects orders beyond the massive base limit
...
### 137. a powered Strategic Supply Complex adds and upgrades massive supply capacity
...
### 138. the Strategic Supply Complex is larger than every production building
...
### 139. factories choose an unobstructed exit when the preferred spawn is blocked
...
### 140. factories do not deploy a completed unit on top of another unit
...
### 141. player and enemy factories spread repeated output across rally formations
...
### 142. setting a new factory rally point resets its formation slots
...
### 143. matching factories share an atomic grouped rally point and formation
...
### 144. grouped rally rejects mixed factory types and tiers without changing either
...
### 145. a completed unit waits in a surrounded factory until an exit opens
...
### 146. newly produced combat units engage threats while rallying
...
### 147. workers spend crystal and complete new structures
...
### 148. damage to an unfinished building persists through construction and completion
...
### 149. Shift-queued construction completes foundations in placement order
...
### 150. ordinary build orders replace queued construction and move orders clear it
...
### 151. cancelling construction removes it from worker queues and advances current work
...
### 152. powered sentry turrets automatically defend against nearby enemies
...
### 153. powered sentry turrets automatically attack hostile structures
...
### 154. a sentry capacitor charges from live generator output and fires without a grid battery
...
### 155. a relay-connected sentry capacitor accepts partial surplus generator output
...
### 156. full idle sentries do not prevent a new sentry from charging
...
### 157. workers can build and upgrade every Shield Turret tier
...
### 158. Shield Turret protection radii use the expanded balance values
...
### 159. Shield Turret upgrades retain existing strength and regenerate the added capacity
...
### 160. higher-tier Shield Turrets protect targets beyond the Tier 1 field
...
### 161. a powered Shield Turret absorbs hits inside its field and spills excess damage through
...
### 162. a powered Shield Turret protects its own structure
...
### 163. Shield Turrets do not intercept attacks outside their field or while unpowered
...
### 164. a damaged Shield Turret regenerates slowly by drawing local grid energy
...
### 165. destroyed reclamation drones drop their carried crystal scrap at the death location
...
### 166. both sides start with a Headquarters, three workers, a Tier 1 factory, a generator, and a powered Crystal Harvester
...
### 167. Crystal Harvesters can only be placed on unused crystal deposits and snap to them
...
### 168. energy-production buildings can be placed away from crystal deposits
...
### 169. units route around structures without crossing their collision footprint
...
### 170. a worker can leave the lane after completing a building beside another structure
...
### 171. workers can construct from a corner of a rectangular building footprint
...
### 172. a lower-tier worker cannot resume an advanced foundation
...
### 173. right-click build commands can resume an unfinished friendly structure
...
### 174. a replacement worker can finish a project after the original builder dies
...
### 175. a worker keeps its construction assignment through stasis and resumes after reactivation
...
### 176. construction placement rejects foundations that overlap existing buildings
...
### 177. buildings may occupy directly adjacent grid cells without invisible padding
...
### 178. friendly units vacate a construction site when its foundation is placed
...
### 179. construction placement still rejects sites occupied by hostile units
...
### 180. ordinary buildings snap to the shared 40-unit construction grid
...
### 181. odd and even building footprints align every edge to a grid line
...
### 182. building classes use distinct grid footprints
...
### 183. Crystal Harvester footprints never exceed two grid cells per side
...
### 184. the Tier 2 Power Relay Tower stays compact and improves every relay function
...
### 185. enemy AI searches nearby grid cells when its preferred generator site is occupied
...
### 186. enemy AI construction avoids sites controlled by a superior hostile force
...
### 187. enemy AI remembers recently destroyed construction sites
...
### 188. enemy AI skips a contested deposit for a safer expansion
...
### 189. enemy AI requests generators instead of Grid Batteries at every energy level
...
### 190. enemy AI proactively maintains multiple paid Pulse Generators
...
### 191. enemy AI scales generator count and output headroom with its consumers
...
### 192. advanced AI economies add generators matching their operational tier
...
### 193. enemy AI waits for its pending generator without adding a Grid Battery
...
### 194. enemy AI requests flak when aircraft threaten its base
...
### 195. a stable AI builds vehicle and air production through each available tier
...
### 196. every AI commander independently requests its missing vehicle branch
...
### 197. a mature enemy economy deliberately progresses through Tier 2 and Tier 3 factories
...
### 198. advanced enemy mech factories produce the worker generation needed for the next tier
...
### 199. enemy AI builds at most one charger and only for depleted staged units
...
### 200. enemy AI routes depleted staged units into its charger and waits for recharge
...
### 201. the standard enemy opening establishes defenses and launches promptly
...
### 202. enemy AI builds generation before spending crystal on an unpowered consumer
...
### 203. enemy AI places a needed relay on its connected grid
...
### 204. enemy AI places powered consumers inside its energized grid
...
### 205. enemy AI completes extra generation before projected demand exceeds supply
...
### 206. enemy AI reassigns an idle worker to an abandoned foundation
...
### 207. enemy AI builds an initial combat force before reserving for expensive construction
...
### 208. enemy AI balances combat roles and adds energy support as its army grows
...
### 209. enemy AI reserves crystal for its next generator after fielding a combat force
...
### 210. enemy AI only constructs a Supply Complex when its remaining supply is low
...
### 211. enemy AI establishes a paid outpost and expands to another crystal deposit
...
### 212. fortified opposition accelerates AI expansion beyond two harvesters
...
### 213. AI strategy requests a sentry at every undefended remote harvester
...
### 214. AI outpost garrisons stay out of attack waves and answer local threats
...
### 215. enemy AI expands beyond four harvesters when crystal is low and skips player claims
...
### 216. workers begin construction at the floating-point edge of build range
...
### 217. enemy combat units wait for a full wave before attacking
...
### 218. enemy AI does not count armed workers as an attack wave
...
### 219. enemy combat units fire at nearby workers while advancing
...
### 220. enemy AI holds an outmatched wave until enough attackers are staged
...
### 221. enemy AI chooses a safer target instead of attacking a defended position
...
### 222. an already dispatched AI assault does not turn around when defenses appear
...
### 223. enemy combat units immediately answer structures rushed near their base as a wave
...
### 224. enemy rush responses wait for a coordinated force instead of sending one unit
...
### 225. cancelling construction removes the foundation, clears workers, and refunds unbuilt crystal
...
### 226. destroying every enemy unit and building ends the match in victory
...
### 227. losing every player unit and building ends the match in defeat
...
### 228. destroying a Headquarters instantly eliminates all of that commander's assets
...
### 229. field tests enable elimination while isolated simulations remain opt-in
...
### 230. multiplayer field tests disable the enemy commander AI
...
### 231. simulation snapshots restore a playable multiplayer client state
...
### 232. mixed human and AI matches continue until only one command team remains
...
### 233. multiplayer lobby codes are exactly ten uppercase letters and numbers
...
### 234. every player count offers multiple dense and selectable battlefield layouts
...
### 235. the three-player ancient ruins map is a dense ruin complex
...
### 236. an eight-player match gives every commander the standard starting package
...
### 237. match teams preserve per-AI difficulty and player-selected alliances
...
### 238. AI difficulty changes deterministic decision cadence and attack preparation
...
### 239. allied commanders share vision, reject friendly fire, and win together
...
### 240. snapshots preserve AI difficulties and commander alliances
...
### 241. every AI commander makes decisions with independent state and resources
...
### 242. victory waits until every AI commander has been eliminated
...
### 243. snapshots preserve multi-AI teams, starts, maps, and decision state
...
### 244. tactical minimap crystal markers use bright fog-independent colors
