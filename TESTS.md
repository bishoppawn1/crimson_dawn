...
**Automated tests documented:** 329
...
### 57. group movement staggers expensive path replans across simulation ticks
...
### 58. large formations cap visibility-path searches per simulation tick
...
### 59. formation movement accepts more than 200 units at once
...
### 60. dense expanded bases bound obstacle corners considered by each route search
...
### 61. ground units escape U-shaped terrain instead of dead-ending against the back wall
...
### 62. move orders placed on structures resolve to a reachable footprint edge
...
### 63. aircraft fly directly over terrain, starting walls, and structures
...
### 64. reclamation drones also route around impassable terrain
...
### 65. reclamation drones pathfind out of concave terrain instead of dead-ending
...
### 66. reclamation drones fly directly over starting walls
...
### 67. vehicles are larger than same-tier mechs and tanks are larger than scouts
...
### 68. higher-tier unit sprites grow and armed variants add visible hardpoints
...
### 69. Zenith Doughnuts are enormous and fast strategic aircraft
...
### 70. overlapping friendly and enemy units physically separate
...
### 71. unit separation exits after one pass when no units overlap
...
### 72. finished ticks remove destroyed entity tombstones from active collections
...
### 73. idle armies stagger automatic target scans after their initial acquisition
...
### 74. movement consumes energy and an exhausted unit enters stasis
...
### 75. stasis regenerates only to the reactivation threshold before control returns
...
### 76. active low-energy units passively regenerate an emergency reserve
...
### 77. emergency regeneration lets an energy-starved unit resume firing
...
### 78. every active unit slowly regenerates to 20 percent energy
...
### 79. attacking damages the target and spends the attacker's energy
...
### 80. heavy unit projectiles deal no damage before their visible impact
...
### 81. mobile artillery trades a close-range dead zone for long-range fire
...
### 82. long-range projectile events remain visible until their delayed impact
...
### 83. ordinary weapons deal reduced damage to aircraft
...
### 84. Interceptors prioritize aircraft and trade ground damage for air superiority
...
### 85. dedicated anti-air units deal bonus damage to aircraft
...
### 86. flak turrets prioritize aircraft and apply their air damage bonus
...
### 87. Raiders are fast harassment units that deal bonus damage to structures
...
### 88. Raiders automatically prioritize exposed infrastructure
...
### 89. Overdrive is restricted by unit capability and consumes energy
...
### 90. a linked charger draws stored energy from a grid battery
...
### 91. the faster Induction Charger transfers its provisional maximum rate
...
### 92. the enlarged Induction Charger field reaches 260 world units
...
### 93. an Induction Charger charges every unit in its field simultaneously
...
### 94. all units receive the full charger rate when the grid can supply it
...
### 95. every unit type has the enlarged provisional energy capacity
...
### 96. a charger outside the generator network cannot charge units
...
### 97. generators continuously produce and retain a capped internal reserve
...
### 98. battery storage is capped by completed battery capacity
...
### 99. an isolated charged battery powers its local grid while discharging
...
### 100. Crystal Harvesters continuously consume their passive power demand
...
### 101. a charged relay keeps its local grid alive after its generator is destroyed
...
### 102. an active factory queue adds production demand and lowers net energy
...
### 103. destroying a battery removes its stored energy and capacity
...
### 104. an energy carrier automatically supplies allies without crossing its protected reserve
...
### 105. an energy carrier spends exactly the energy shared fairly with nearby units
...
### 106. every mobile energy supplier transfers its matching output rate
...
### 107. every mobile energy supplier carries a tier-improving defensive weapon
...
### 108. destroyed units create finite reclaimable wreckage
...
### 109. nearby wrecks consolidate into larger resource-conserving scrap piles
...
### 110. wreck consolidation redirects reclamation drones to the surviving pile
...
### 111. a powered salvage yard automatically returns wreck crystal
...
### 112. multiple reclamation drones can harvest the same crystal scrap pile
...
### 113. partially loaded reclamation drones visit another crystal scrap pile before returning
...
### 114. a powered yard replaces a destroyed drone for free after a delay
...
### 115. combat units automatically attack hostile units that enter weapon range
...
### 116. worker drones have weak, short-range defensive weapons
...
### 117. worker drones do not target or retaliate while constructing
...
### 118. worker drones repair damaged friendly units and completed buildings with energy
...
### 119. idle worker drones automatically repair the nearest damaged friendly target
...
### 120. automatic worker repair respects its service radius and higher-priority orders
...
### 121. active construction takes priority over automatic worker repair
...
### 122. worker drones can repair one another but can never repair themselves
...
### 123. an active repair assignment takes priority over worker combat
...
### 124. combat units automatically attack hostile structures in weapon range
...
### 125. player and enemy units pursue the hostile aggressor that damages them
...
### 126. force-moving units do not abandon their order to retaliate
...
### 127. a moving unit stops to attack and resumes its route after the target is destroyed
...
### 128. a force move ignores enemies until the unit reaches its destination
...
### 129. power relay towers extend a generator network to distant structures
...
### 130. power coverage uses the same grid-aligned square cells as network connections
...
### 131. powered Crystal Harvesters generate crystal over time
...
### 132. bright Rich Crystal Deposits increase a harvester's actual crystal output
...
### 133. each mech factory tier offers improved copies of the same six unit roles
...
### 134. vehicle factories produce six matching-tier vehicle roles
...
### 135. air factories begin at Tier 2 and produce six matching-tier aircraft roles
...
### 136. all flying units use the faster movement profiles
...
### 137. Dropships begin at Tier 2 in Air Factories with eight ground-unit cargo slots
...
### 138. explicit transport orders reserve eight slots, board nearby units, and unload them
...
### 139. multi-transport filling balances reservations and rejects aircraft cargo
...
### 140. destroying a loaded Dropship destroys its passengers and snapshots preserve cargo
...
### 141. all units and structures provide a useful deterministic vision range
...
### 142. enemy contacts are hidden until they enter current friendly vision
...
### 143. powered radar arrays reveal long range and lose that coverage off-grid
...
### 144. radar towers and mobile radar units improve across every available branch tier
...
### 145. enemy AI invests in radar after preserving its opening wave and garrison
...
### 146. direct attack commands cannot target unseen enemies
...
### 147. vehicle and air factories only queue units from their own tier and branch
...
### 148. vehicle and air factories deploy their completed production orders
...
### 149. mech factories only queue the six unit variants matching their tier
...
### 150. matching factory groups route production to the shortest powered queue
...
### 151. repeated group production orders distribute across matching factories
...
### 152. group production skips unpowered factories and rejects mixed factory types
...
### 153. a Tier 1 mech factory spends crystal and constructs a worker drone
...
### 154. unit roles and tiers reserve different provisional supply amounts
...
### 155. production reserves supply and rejects orders beyond the massive base limit
...
### 156. a powered Strategic Supply Complex adds and upgrades massive supply capacity
...
### 157. the Strategic Supply Complex is larger than every production building
...
### 158. factories choose an unobstructed exit when the preferred spawn is blocked
...
### 159. factories do not deploy a completed unit on top of another unit
...
### 160. player and enemy factories spread repeated output across rally formations
...
### 161. setting a new factory rally point resets its formation slots
...
### 162. matching factories share an atomic grouped rally point and formation
...
### 163. grouped rally rejects mixed factory types and tiers without changing either
...
### 164. a completed unit waits in a surrounded factory until an exit opens
...
### 165. newly produced combat units engage threats while rallying
...
### 166. workers spend crystal and complete new structures
...
### 167. damage to an unfinished building persists through construction and completion
...
### 168. Shift-queued construction completes foundations in placement order
...
### 169. ordinary build orders replace queued construction and move orders clear it
...
### 170. cancelling construction removes it from worker queues and advances current work
...
### 171. powered sentry turrets automatically defend against nearby enemies
...
### 172. powered sentry turrets automatically attack hostile structures
...
### 173. a sentry capacitor charges from live generator output and fires without a grid battery
...
### 174. a relay-connected sentry capacitor accepts partial surplus generator output
...
### 175. full idle sentries do not prevent a new sentry from charging
...
### 176. workers can build and upgrade every Shield Turret tier
...
### 177. Shield Turret protection radii use the expanded balance values
...
### 178. Shield Turret upgrades retain existing strength and regenerate the added capacity
...
### 179. higher-tier Shield Turrets protect targets beyond the Tier 1 field
...
### 180. a powered Shield Turret absorbs hits inside its field and spills excess damage through
...
### 181. a powered Shield Turret protects its own structure
...
### 182. Shield Turrets do not intercept attacks outside their field or while unpowered
...
### 183. a damaged Shield Turret regenerates slowly by drawing local grid energy
...
### 184. destroyed reclamation drones drop their carried crystal scrap at the death location
...
### 185. both sides start with a Headquarters, three workers, a Tier 1 factory, a generator, and a powered Crystal Harvester
...
### 186. Crystal Harvesters can only be placed on unused crystal deposits and snap to them
...
### 187. energy-production buildings can be placed away from crystal deposits
...
### 188. units route around structures without crossing their collision footprint
...
### 189. a worker can leave the lane after completing a building beside another structure
...
### 190. workers can construct from a corner of a rectangular building footprint
...
### 191. a lower-tier worker cannot resume an advanced foundation
...
### 192. right-click build commands can resume an unfinished friendly structure
...
### 193. a replacement worker can finish a project after the original builder dies
...
### 194. a worker keeps its construction assignment through stasis and resumes after reactivation
...
### 195. construction placement rejects foundations that overlap existing buildings
...
### 196. buildings may occupy directly adjacent grid cells without invisible padding
...
### 197. friendly units vacate a construction site when its foundation is placed
...
### 198. construction placement still rejects sites occupied by hostile units
...
### 199. ordinary buildings snap to the shared 40-unit construction grid
...
### 200. odd and even building footprints align every edge to a grid line
...
### 201. building classes use distinct grid footprints
...
### 202. Tier 3 ordinary buildings retain their Tier 2 footprint and physical radius
...
### 203. Crystal Harvester footprints never exceed two grid cells per side
...
### 204. the Tier 2 Power Relay Tower stays compact and improves every relay function
...
### 205. enemy AI searches nearby grid cells when its preferred generator site is occupied
...
### 206. enemy AI construction avoids sites controlled by a superior hostile force
...
### 207. enemy AI remembers recently destroyed construction sites
...
### 208. enemy AI skips a contested deposit for a safer expansion
...
### 209. enemy AI requests generators instead of Grid Batteries at every energy level
...
### 210. enemy AI proactively maintains multiple paid Pulse Generators
...
### 211. enemy AI scales generator count and output headroom with its consumers
...
### 212. advanced AI economies add generators matching their operational tier
...
### 213. enemy AI waits for its pending generator without adding a Grid Battery
...
### 214. enemy AI requests flak when aircraft threaten its base
...
### 215. a stable AI builds vehicle and air production through each available tier
...
### 216. every AI commander independently requests its missing vehicle branch
...
### 217. a mature enemy economy deliberately progresses through Tier 2 and Tier 3 factories
...
### 218. advanced enemy mech factories produce the worker generation needed for the next tier
...
### 219. enemy AI builds at most one charger and only for depleted staged units
...
### 220. enemy AI routes depleted staged units into its charger and waits for recharge
...
### 221. the standard enemy opening establishes defenses and launches promptly
...
### 222. enemy AI builds generation before spending crystal on an unpowered consumer
...
### 223. enemy AI places a needed relay on its connected grid
...
### 224. enemy AI places powered consumers inside its energized grid
...
### 225. enemy AI completes extra generation before projected demand exceeds supply
...
### 226. enemy AI reassigns an idle worker to an abandoned foundation
...
### 227. enemy AI builds an initial combat force before reserving for expensive construction
...
### 228. enemy AI balances combat roles and adds energy support as its army grows
...
### 229. enemy AI never exceeds three mobile energy suppliers across all branches
...
### 230. enemy AI reserves crystal for its next generator after fielding a combat force
...
### 231. enemy AI only constructs a Supply Complex when its remaining supply is low
...
### 232. enemy AI establishes a paid outpost and expands to another crystal deposit
...
### 233. fortified opposition accelerates AI expansion beyond two harvesters
...
### 234. AI places each remote harvester sentry on its enemy-facing side
...
### 235. AI outpost garrisons stay out of attack waves and answer local threats
...
### 236. enemy AI expands beyond four harvesters when crystal is low and skips player claims
...
### 237. workers begin construction at the floating-point edge of build range
...
### 238. enemy combat units wait for a full wave before attacking
...
### 239. enemy AI does not count armed workers as an attack wave
...
### 240. enemy combat units fire at nearby workers while advancing
...
### 241. enemy AI holds an outmatched wave until enough attackers are staged
...
### 242. enemy AI chooses a safer target instead of attacking a defended position
...
### 243. an already dispatched AI assault does not turn around when defenses appear
...
### 244. enemy combat units immediately answer structures rushed near their base as a wave
...
### 245. enemy rush responses wait for a coordinated force instead of sending one unit
...
### 246. cancelling construction removes the foundation, clears workers, and refunds unbuilt crystal
...
### 247. a commander can destroy one completed building without a refund
...
### 248. destroying every enemy unit and building ends the match in victory
...
### 249. losing every player unit and building ends the match in defeat
...
### 250. destroying a Headquarters instantly eliminates all of that commander's assets
...
### 251. field tests enable elimination while isolated simulations remain opt-in
...
### 252. multiplayer field tests disable the enemy commander AI
...
### 253. simulation snapshots restore a playable multiplayer client state
...
### 254. mixed human and AI matches continue until only one command team remains
...
### 255. multiplayer lobby codes are exactly ten uppercase letters and numbers
...
### 256. every player count offers multiple dense and selectable battlefield layouts
...
### 257. the three-player ancient ruins map is a dense ruin complex
...
### 258. an eight-player match gives every commander the standard starting package
...
### 259. match teams preserve per-AI difficulty and player-selected alliances
...
### 260. AI difficulty changes deterministic decision cadence and attack preparation
...
### 261. eliminated AI commanders stop running strategic decisions
...
### 262. allied commanders share vision, reject friendly fire, and win together
...
### 263. snapshots preserve AI difficulties and commander alliances
...
### 264. every AI commander makes decisions with independent state and resources
...
### 265. victory waits until every AI commander has been eliminated
...
### 266. snapshots preserve multi-AI teams, starts, maps, and decision state
...
### 267. tactical minimap crystal markers use bright fog-independent colors
...
### 268. mortar shells travel faster and keep tracking moving targets
...
### 269. enemy AI assigns spare workers to powered factory production
...
### 270. enemy AI adds shield coverage after establishing its core force
