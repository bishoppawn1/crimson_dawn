...
**Automated tests documented:** 354
...
### 5. Spawn Wars platforms move freely and refund 75 percent of their original cost
...
### 6. Spawn Wars income, center control, equal speed, kill rewards, and objectives are deterministic
...
### 7. Spawn Wars unit deaths never create crystal scrap for either alliance
...
### 8. unit production and building construction use the global 4x duration scale
...
### 9. the irreplaceable Command Headquarters provides economy and only Tier 1 workers
...
### 10. the Command Headquarters automatically fires its long-range defensive gun
...
### 11. the tactical minimap fits the whole battlefield and maps its viewport
...
### 12. worker tiers expose the requested inherited construction matrix
...
### 13. Tier 3 workers unlock the nuclear launcher and 2x2 anti-nuke turret
...
### 14. nuclear launchers construct one paid missile at a time and pause without power
...
### 15. nuclear missiles fly for exactly ten seconds and damage every team in three bands
...
### 16. powered anti-nuke turrets protect a 30x30-cell area and preserve interception vision
...
### 17. a nuclear missile grants its launching alliance short-range moving vision
...
### 18. nuclear missile and launcher readiness survive multiplayer snapshots
...
### 19. unit tester advantages apply only to the designated human team
...
### 20. unit tester construction completes immediately while AI construction stays normal
...
### 21. unit tester factory orders deploy on the next simulation step without spending crystal
...
### 22. unit tester team rules survive simulation snapshots
...
### 23. unit tester can instantly place completed buildings for an AI without funding it
...
### 24. unit tester can place collision-safe AI units that retain ordinary ownership
...
### 25. enemy spawning is unavailable outside Unit Tester and cannot target the tester team
...
### 26. construction authorization is enforced by the simulation
...
### 27. production-building branches expose their requested tiers
...
### 28. experimental factory exposes three distinct strategic units
...
### 29. experimental factory accepts paid production orders
...
### 30. hexapod landship strides through structures but still respects terrain
...
### 31. hexapod landship shells deal damage on impact instead of before firing
...
### 32. hexapod landship fires its independent weapons while moving
...
### 33. Zenith Doughnut stops before firing its ground beam
...
### 34. Zenith Doughnut beam pursuit only auto-acquires nearby ground targets
...
### 35. Zenith Doughnut AA batteries independently fire on aircraft during ground-beam attacks
...
### 36. explicit Zenith Doughnut anti-air orders pursue aircraft into battery range
...
### 37. Zenith Doughnuts hover directly over a locally acquired target
...
### 38. explicit orders take priority over automatic Zenith pursuit
...
### 39. airborne Zenith Doughnuts do not push ground units out of their beam
...
### 40. higher-tier building variants retain their family behavior
...
### 41. every higher-tier infrastructure building improves its defining function
...
### 42. higher-tier sentries deal more damage and reach targets that Tier 1 cannot
...
### 43. sentry turrets use the strengthened weapon profiles
...
### 44. mortar turrets enforce minimum and maximum range
...
### 45. workers can build and upgrade every mortar turret tier
...
### 46. higher-tier factories have progressively faster production throughput
...
### 47. workers provide reduced tier-specific factory assistance at an added grid cost
...
### 48. worker assistance power draw increases one percentage point per worker
...
### 49. factory production pauses when its grid cannot cover worker assistance demand
...
### 50. production assistance requires an active friendly factory and overrides worker combat
...
### 51. completed mech factories globally unlock matching structure upgrades
...
### 52. structure upgrade unlocks are team-specific and expanded footprints need clear space
...
### 53. selected workers upgrade only one tier while preserving their active state
...
### 54. enemy AI structure upgrades keep its strategic crystal reserve
...
### 55. enemy AI does not upgrade existing Grid Batteries
...
### 56. enemy AI upgrades existing economy buildings after unlocking their tier
...
### 57. enemy AI purchases an eligible upgrade before routine production consumes its surplus
...
### 58. higher-tier Crystal Harvesters still snap to deposits
...
### 59. the standard battlefield uses the much larger map and separated starting bases
...
### 60. single-player map selection resolves every available battlefield
...
### 61. multiplayer ignores a manual map choice and resolves a random shared map
...
### 62. multiplayer snapshots preserve the host-selected map
...
### 63. both starting bases have sparse symmetrical walls with open central gates
...
### 64. impassable terrain rejects construction and redirects destinations inside it
...
### 65. queued move orders hand units through each waypoint in order
...
### 66. patrol orders repeat every recorded point and survive snapshots
...
### 67. patrol requires two points and explicit movement commands cancel it
...
### 68. ordinary move orders replace queued waypoints
...
### 69. ground units route around impassable terrain without entering it
...
### 70. ground units relocate out of a structure pocket when no route remains
...
### 71. group movement staggers expensive path replans across simulation ticks
...
### 72. large formations cap visibility-path searches per simulation tick
...
### 73. formation movement accepts more than 200 units at once
...
### 74. dense expanded bases bound obstacle corners considered by each route search
...
### 75. ground units escape U-shaped terrain instead of dead-ending against the back wall
...
### 76. move orders placed on structures resolve to a reachable footprint edge
...
### 77. aircraft fly directly over terrain, starting walls, and structures
...
### 78. reclamation drones also route around impassable terrain
...
### 79. reclamation drones pathfind out of concave terrain instead of dead-ending
...
### 80. reclamation drones fly directly over starting walls
...
### 81. vehicles are larger than same-tier mechs and tanks are larger than scouts
...
### 82. higher-tier unit sprites grow and armed variants add visible hardpoints
...
### 83. Zenith Doughnuts are enormous and fast strategic aircraft
...
### 84. overlapping friendly and enemy units physically separate
...
### 85. unit separation exits after one pass when no units overlap
...
### 86. finished ticks remove destroyed entity tombstones from active collections
...
### 87. idle armies stagger automatic target scans after their initial acquisition
...
### 88. movement consumes energy and an exhausted unit enters stasis
...
### 89. stasis regenerates only to the reactivation threshold before control returns
...
### 90. active low-energy units passively regenerate an emergency reserve
...
### 91. emergency regeneration lets an energy-starved unit resume firing
...
### 92. every active unit slowly regenerates to 20 percent energy
...
### 93. attacking damages the target and spends the attacker's energy
...
### 94. heavy unit projectiles deal no damage before their visible impact
...
### 95. mobile artillery trades a close-range dead zone for long-range fire
...
### 96. long-range projectile events remain visible until their delayed impact
...
### 97. ordinary weapons deal reduced damage to aircraft
...
### 98. Interceptors prioritize aircraft and trade ground damage for air superiority
...
### 99. dedicated anti-air units deal bonus damage to aircraft
...
### 100. flak turrets prioritize aircraft and apply their air damage bonus
...
### 101. Overdrive is restricted by unit capability and consumes energy
...
### 102. a linked charger draws stored energy from a grid battery
...
### 103. the faster Induction Charger transfers its provisional maximum rate
...
### 104. the enlarged Induction Charger field reaches 260 world units
...
### 105. an Induction Charger charges every unit in its field simultaneously
...
### 106. all units receive the full charger rate when the grid can supply it
...
### 107. every unit type has the enlarged provisional energy capacity
...
### 108. a charger outside the generator network cannot charge units
...
### 109. generators continuously produce and retain a capped internal reserve
...
### 110. battery storage is capped by completed battery capacity
...
### 111. an isolated charged battery powers its local grid while discharging
...
### 112. Crystal Harvesters continuously consume their passive power demand
...
### 113. a charged relay keeps its local grid alive after its generator is destroyed
...
### 114. an active factory queue adds production demand and lowers net energy
...
### 115. destroying a battery removes its stored energy and capacity
...
### 116. an energy carrier automatically supplies allies without crossing its protected reserve
...
### 117. an energy carrier spends exactly the energy shared fairly with nearby units
...
### 118. every mobile energy supplier transfers its matching output rate
...
### 119. every mobile energy supplier carries a tier-improving defensive weapon
...
### 120. destroyed units create finite reclaimable wreckage
...
### 121. destroyed buildings create one finite reclaimable scrap pile
...
### 122. nearby wrecks consolidate into larger resource-conserving scrap piles
...
### 123. wreck consolidation redirects reclamation drones to the surviving pile
...
### 124. a powered salvage yard automatically returns wreck crystal
...
### 125. upgrading a salvage yard immediately improves its existing drones
...
### 126. multiple reclamation drones can harvest the same crystal scrap pile
...
### 127. partially loaded reclamation drones visit another crystal scrap pile before returning
...
### 128. a powered yard replaces a destroyed drone for free after a delay
...
### 129. combat units automatically attack hostile units that enter weapon range
...
### 130. worker drones have weak, short-range defensive weapons
...
### 131. worker drones do not target or retaliate while constructing
...
### 132. worker drones repair damaged friendly units and completed buildings with energy
...
### 133. idle worker drones automatically repair the nearest damaged friendly target
...
### 134. automatic worker repair respects its service radius and higher-priority orders
...
### 135. active construction takes priority over automatic worker repair
...
### 136. worker drones can repair one another but can never repair themselves
...
### 137. an active repair assignment takes priority over worker combat
...
### 138. combat units automatically attack hostile structures in weapon range
...
### 139. player and enemy units pursue the hostile aggressor that damages them
...
### 140. force-moving units do not abandon their order to retaliate
...
### 141. a moving unit stops to attack and resumes its route after the target is destroyed
...
### 142. a force move ignores enemies until the unit reaches its destination
...
### 143. power relay towers extend a generator network to distant structures
...
### 144. power coverage uses the same grid-aligned square cells as network connections
...
### 145. powered Crystal Harvesters generate crystal over time
...
### 146. bright Rich Crystal Deposits increase a harvester's actual crystal output
...
### 147. each mech factory tier offers improved copies of the same six unit roles
...
### 148. vehicle factories produce six matching-tier vehicle roles
...
### 149. air factories begin at Tier 2 and produce six matching-tier aircraft roles
...
### 150. all flying units use the faster movement profiles
...
### 151. Dropships begin at Tier 2 in Air Factories with eight ground-unit cargo slots
...
### 152. explicit transport orders reserve eight slots, board nearby units, and unload them
...
### 153. multi-transport filling balances reservations and rejects aircraft cargo
...
### 154. destroying a loaded Dropship destroys its passengers and snapshots preserve cargo
...
### 155. all units and structures provide a useful deterministic vision range
...
### 156. enemy contacts are hidden until they enter current friendly vision
...
### 157. powered radar arrays reveal long range and lose that coverage off-grid
...
### 158. the Tier 3 Overseer Spire exposes five zones at 75 percent of Tier 1 radar radius
...
### 159. Overseer orbital vision relocates without overlapping allied sight or other zones
...
### 160. Overseer zones fall back to the position with the most undiscovered area
...
### 161. radar towers and mobile radar units improve across every available branch tier
...
### 162. enemy AI invests in radar after preserving its opening wave and garrison
...
### 163. direct attack commands cannot target unseen enemies
...
### 164. vehicle and air factories only queue units from their own tier and branch
...
### 165. vehicle and air factories deploy their completed production orders
...
### 166. mech factories only queue the six unit variants matching their tier
...
### 167. matching factory groups route production to the shortest powered queue
...
### 168. repeated group production orders distribute across matching factories
...
### 169. group production skips unpowered factories and rejects mixed factory types
...
### 170. a Tier 1 mech factory spends crystal and constructs a worker drone
...
### 171. unit roles and tiers reserve different provisional supply amounts
...
### 172. production reserves supply and rejects orders beyond the massive base limit
...
### 173. a powered Strategic Supply Complex adds and upgrades massive supply capacity
...
### 174. the Strategic Supply Complex is larger than every production building
...
### 175. factories choose an unobstructed exit when the preferred spawn is blocked
...
### 176. factories do not deploy a completed unit on top of another unit
...
### 177. player and enemy factories spread repeated output across rally formations
...
### 178. setting a new factory rally point resets its formation slots
...
### 179. matching factories share an atomic grouped rally point and formation
...
### 180. grouped rally rejects mixed factory types and tiers without changing either
...
### 181. a completed unit waits in a surrounded factory until an exit opens
...
### 182. newly produced combat units engage threats while rallying
...
### 183. workers spend crystal and complete new structures
...
### 184. damage to an unfinished building persists through construction and completion
...
### 185. Shift-queued construction completes foundations in placement order
...
### 186. ordinary build orders replace queued construction and move orders clear it
...
### 187. cancelling construction removes it from worker queues and advances current work
...
### 188. powered sentry turrets automatically defend against nearby enemies
...
### 189. powered sentry turrets automatically attack hostile structures
...
### 190. a sentry capacitor charges from live generator output and fires without a grid battery
...
### 191. a relay-connected sentry capacitor accepts partial surplus generator output
...
### 192. full idle sentries do not prevent a new sentry from charging
...
### 193. workers can build and upgrade every Shield Turret tier
...
### 194. Shield Turret protection radii use the expanded balance values
...
### 195. Shield Turret upgrades retain existing strength and regenerate the added capacity
...
### 196. higher-tier Shield Turrets protect targets beyond the Tier 1 field
...
### 197. a powered Shield Turret absorbs hits inside its field and spills excess damage through
...
### 198. a powered Shield Turret protects its own structure
...
### 199. Shield Turrets do not intercept attacks outside their field or while unpowered
...
### 200. a damaged Shield Turret regenerates slowly by drawing local grid energy
...
### 201. destroyed reclamation drones drop their carried crystal scrap at the death location
...
### 202. both sides start with a Headquarters, three workers, a Tier 1 factory, a generator, and a powered Crystal Harvester
...
### 203. Crystal Harvesters can only be placed on unused crystal deposits and snap to them
...
### 204. energy-production buildings can be placed away from crystal deposits
...
### 205. units route around structures without crossing their collision footprint
...
### 206. a worker can leave the lane after completing a building beside another structure
...
### 207. workers can construct from a corner of a rectangular building footprint
...
### 208. a lower-tier worker cannot resume an advanced foundation
...
### 209. right-click build commands can resume an unfinished friendly structure
...
### 210. a replacement worker can finish a project after the original builder dies
...
### 211. a worker keeps its construction assignment through stasis and resumes after reactivation
...
### 212. construction placement rejects foundations that overlap existing buildings
...
### 213. buildings may occupy directly adjacent grid cells without invisible padding
...
### 214. friendly units vacate a construction site when its foundation is placed
...
### 215. new foundations immediately relocate idle units pinned against a factory
...
### 216. construction placement still rejects sites occupied by hostile units
...
### 217. ordinary buildings snap to the shared 40-unit construction grid
...
### 218. odd and even building footprints align every edge to a grid line
...
### 219. building classes use distinct grid footprints
...
### 220. Tier 3 ordinary buildings retain their Tier 2 footprint and physical radius
...
### 221. Crystal Harvester footprints never exceed two grid cells per side
...
### 222. the Tier 2 Power Relay Tower stays compact and improves every relay function
...
### 223. enemy AI searches nearby grid cells when its preferred generator site is occupied
...
### 224. enemy AI construction avoids sites controlled by a superior hostile force
...
### 225. enemy AI remembers recently destroyed construction sites
...
### 226. enemy AI skips a contested deposit for a safer expansion
...
### 227. enemy AI requests generators instead of Grid Batteries at every energy level
...
### 228. enemy AI proactively maintains multiple paid Pulse Generators
...
### 229. enemy AI scales generator count and output headroom with its consumers
...
### 230. advanced AI economies add generators matching their operational tier
...
### 231. enemy AI waits for its pending generator without adding a Grid Battery
...
### 232. enemy AI requests flak when aircraft threaten its base
...
### 233. a stable AI builds vehicle and air production through each available tier
...
### 234. every AI commander independently requests its missing vehicle branch
...
### 235. a mature enemy economy deliberately progresses through Tier 2 and Tier 3 factories
...
### 236. advanced enemy mech factories produce the worker generation needed for the next tier
...
### 237. enemy AI builds at most one charger and only for depleted staged units
...
### 238. enemy AI routes depleted staged units into its charger and waits for recharge
...
### 239. the standard enemy opening establishes defenses and launches promptly
...
### 240. enemy AI builds generation before spending crystal on an unpowered consumer
...
### 241. enemy AI places a needed relay on its connected grid
...
### 242. enemy AI places powered consumers inside its energized grid
...
### 243. enemy AI completes extra generation before projected demand exceeds supply
...
### 244. enemy AI reassigns an idle worker to an abandoned foundation
...
### 245. enemy AI builds an initial combat force before reserving for expensive construction
...
### 246. enemy AI balances combat roles and adds energy support as its army grows
...
### 247. enemy AI never exceeds three mobile energy suppliers across all branches
...
### 248. enemy AI reserves crystal for its next generator after fielding a combat force
...
### 249. enemy AI only constructs a Supply Complex when its remaining supply is low
...
### 250. enemy AI establishes a paid outpost and expands to another crystal deposit
...
### 251. fortified opposition accelerates AI expansion beyond two harvesters
...
### 252. AI places each remote harvester sentry on its enemy-facing side
...
### 253. AI outpost garrisons stay out of attack waves and answer local threats
...
### 254. enemy AI expands beyond four harvesters when crystal is low and skips player claims
...
### 255. workers begin construction at the floating-point edge of build range
...
### 256. enemy combat units wait for a full wave before attacking
...
### 257. enemy AI does not count armed workers as an attack wave
...
### 258. enemy combat units fire at nearby workers while advancing
...
### 259. enemy AI holds an outmatched wave until enough attackers are staged
...
### 260. enemy AI chooses a safer target instead of attacking a defended position
...
### 261. an already dispatched AI assault does not turn around when defenses appear
...
### 262. enemy combat units immediately answer structures rushed near their base as a wave
...
### 263. enemy rush responses wait for a coordinated force instead of sending one unit
...
### 264. cancelling construction removes the foundation, clears workers, and refunds unbuilt crystal
...
### 265. a commander can destroy one completed building without a refund
...
### 266. destroying every enemy unit and building ends the match in victory
...
### 267. losing every player unit and building ends the match in defeat
...
### 268. destroying a Headquarters leaves inert neutral units and destroys its buildings
...
### 269. field tests enable elimination while isolated simulations remain opt-in
...
### 270. multiplayer field tests disable the enemy commander AI
...
### 271. simulation snapshots restore a playable multiplayer client state
...
### 272. mixed human and AI matches continue until only one command team remains
...
### 273. multiplayer lobby codes are exactly ten uppercase letters and numbers
...
### 274. every player count offers multiple dense and selectable battlefield layouts
...
### 275. the three-player ancient ruins map is a dense ruin complex
...
### 276. an eight-player match gives every commander the standard starting package
...
### 277. match teams preserve per-AI difficulty and player-selected alliances
...
### 278. AI difficulty changes deterministic decision cadence and attack preparation
...
### 279. eliminated AI commanders stop running strategic decisions
...
### 280. allied commanders share vision, reject friendly fire, and win together
...
### 281. snapshots preserve AI difficulties and commander alliances
...
### 282. every AI commander makes decisions with independent state and resources
...
### 283. victory waits until every AI commander has been eliminated
...
### 284. snapshots preserve multi-AI teams, starts, maps, and decision state
...
### 285. tactical minimap crystal markers use bright fog-independent colors
...
### 286. mortar shells travel faster and keep tracking moving targets
...
### 287. enemy AI assigns spare workers to powered factory production
...
### 288. enemy AI adds shield coverage after establishing its core force
