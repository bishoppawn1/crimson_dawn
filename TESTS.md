...
**Automated tests documented:** 328
...
### 202. Crystal Harvester footprints never exceed two grid cells per side
...
### 203. the Tier 2 Power Relay Tower stays compact and improves every relay function
...
### 204. enemy AI searches nearby grid cells when its preferred generator site is occupied
...
### 205. enemy AI construction avoids sites controlled by a superior hostile force
...
### 206. enemy AI remembers recently destroyed construction sites
...
### 207. enemy AI skips a contested deposit for a safer expansion
...
### 208. enemy AI requests generators instead of Grid Batteries at every energy level
...
### 209. enemy AI proactively maintains multiple paid Pulse Generators
...
### 210. enemy AI scales generator count and output headroom with its consumers
...
### 211. advanced AI economies add generators matching their operational tier
...
### 212. enemy AI waits for its pending generator without adding a Grid Battery
...
### 213. enemy AI requests flak when aircraft threaten its base
...
### 214. a stable AI builds vehicle and air production through each available tier
...
### 215. every AI commander independently requests its missing vehicle branch
...
### 216. a mature enemy economy deliberately progresses through Tier 2 and Tier 3 factories
...
### 217. advanced enemy mech factories produce the worker generation needed for the next tier
...
### 218. enemy AI builds at most one charger and only for depleted staged units
...
### 219. enemy AI routes depleted staged units into its charger and waits for recharge
...
### 220. the standard enemy opening establishes defenses and launches promptly
...
### 221. enemy AI builds generation before spending crystal on an unpowered consumer
...
### 222. enemy AI places a needed relay on its connected grid
...
### 223. enemy AI places powered consumers inside its energized grid
...
### 224. enemy AI completes extra generation before projected demand exceeds supply
...
### 225. enemy AI reassigns an idle worker to an abandoned foundation
...
### 226. enemy AI builds an initial combat force before reserving for expensive construction
...
### 227. enemy AI balances combat roles and adds energy support as its army grows
...
### 228. enemy AI never exceeds three mobile energy suppliers across all branches
...
### 229. enemy AI reserves crystal for its next generator after fielding a combat force
...
### 230. enemy AI only constructs a Supply Complex when its remaining supply is low
...
### 231. enemy AI establishes a paid outpost and expands to another crystal deposit
...
### 232. fortified opposition accelerates AI expansion beyond two harvesters
...
### 233. AI places each remote harvester sentry on its enemy-facing side
...
### 234. AI outpost garrisons stay out of attack waves and answer local threats
...
### 235. enemy AI expands beyond four harvesters when crystal is low and skips player claims
...
### 236. workers begin construction at the floating-point edge of build range
...
### 237. enemy combat units wait for a full wave before attacking
...
### 238. enemy AI does not count armed workers as an attack wave
...
### 239. enemy combat units fire at nearby workers while advancing
...
### 240. enemy AI holds an outmatched wave until enough attackers are staged
...
### 241. enemy AI chooses a safer target instead of attacking a defended position
...
### 242. an already dispatched AI assault does not turn around when defenses appear
...
### 243. enemy combat units immediately answer structures rushed near their base as a wave
...
### 244. enemy rush responses wait for a coordinated force instead of sending one unit
...
### 245. cancelling construction removes the foundation, clears workers, and refunds unbuilt crystal
...
### 246. a commander can destroy one completed building without a refund
...
### 247. destroying every enemy unit and building ends the match in victory
...
### 248. losing every player unit and building ends the match in defeat
...
### 249. destroying a Headquarters instantly eliminates all of that commander's assets
...
### 250. field tests enable elimination while isolated simulations remain opt-in
...
### 251. multiplayer field tests disable the enemy commander AI
...
### 252. simulation snapshots restore a playable multiplayer client state
...
### 253. mixed human and AI matches continue until only one command team remains
...
### 254. multiplayer lobby codes are exactly ten uppercase letters and numbers
...
### 255. every player count offers multiple dense and selectable battlefield layouts
...
### 256. the three-player ancient ruins map is a dense ruin complex
...
### 257. an eight-player match gives every commander the standard starting package
...
### 258. match teams preserve per-AI difficulty and player-selected alliances
...
### 259. AI difficulty changes deterministic decision cadence and attack preparation
...
### 260. eliminated AI commanders stop running strategic decisions
...
### 261. allied commanders share vision, reject friendly fire, and win together
...
### 262. snapshots preserve AI difficulties and commander alliances
...
### 263. every AI commander makes decisions with independent state and resources
...
### 264. victory waits until every AI commander has been eliminated
...
### 265. snapshots preserve multi-AI teams, starts, maps, and decision state
...
### 266. tactical minimap crystal markers use bright fog-independent colors
...
### 267. mortar shells travel faster and keep tracking moving targets
...
### 268. enemy AI assigns spare workers to powered factory production
...
### 269. enemy AI adds shield coverage after establishing its core force
