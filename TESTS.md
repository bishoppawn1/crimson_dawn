...
**Automated tests documented:** 300
...
### 9. higher-tier armed sprites render their data-driven weapon attachments
...
### 10. right-clicking an active friendly factory sends selected workers to assist production
...
### 11. worker controls upgrade one tier and keep only one construction tier open
...
### 12. the interface and battlefield present the economy as crimson crystal
...
### 13. match setup exposes per-AI difficulty and team assignment controls
...
### 31. workers provide reduced tier-specific factory assistance at an added grid cost
...
### 32. factory production pauses when its grid cannot cover worker assistance demand
...
### 33. production assistance requires an active friendly factory and overrides worker combat
...
### 34. completed mech factories globally unlock matching structure upgrades
...
### 35. structure upgrade unlocks are team-specific and expanded footprints need clear space
...
### 36. selected workers upgrade only one tier while preserving their active state
...
### 37. enemy AI structure upgrades keep its strategic crystal reserve
...
### 38. enemy AI does not upgrade existing Grid Batteries
...
### 39. enemy AI upgrades existing economy buildings after unlocking their tier
...
### 40. higher-tier Crystal Harvesters still snap to deposits
...
### 41. the standard battlefield uses the much larger map and separated starting bases
...
### 42. single-player map selection resolves every available battlefield
...
### 43. multiplayer ignores a manual map choice and resolves a random shared map
...
### 44. multiplayer snapshots preserve the host-selected map
...
### 45. both starting bases have sparse symmetrical walls with open central gates
...
### 46. impassable terrain rejects construction and redirects destinations inside it
...
### 47. queued move orders hand units through each waypoint in order
...
### 48. ordinary move orders replace queued waypoints
...
### 49. ground units route around impassable terrain without entering it
...
### 50. group movement staggers expensive path replans across simulation ticks
...
### 51. large formations cap visibility-path searches per simulation tick
...
### 52. formation movement accepts more than 200 units at once
...
### 53. dense expanded bases bound obstacle corners considered by each route search
...
### 54. ground units escape U-shaped terrain instead of dead-ending against the back wall
...
### 55. move orders placed on structures resolve to a reachable footprint edge
...
### 56. aircraft fly directly over terrain, starting walls, and structures
...
### 57. reclamation drones also route around impassable terrain
...
### 58. reclamation drones pathfind out of concave terrain instead of dead-ending
...
### 59. reclamation drones fly directly over starting walls
...
### 60. vehicles are larger than same-tier mechs and tanks are larger than scouts
...
### 61. higher-tier unit sprites grow and armed variants add visible hardpoints
...
### 62. Zenith Doughnuts are enormous and fast strategic aircraft
...
### 63. overlapping friendly and enemy units physically separate
...
### 64. unit separation exits after one pass when no units overlap
...
### 65. finished ticks remove destroyed entity tombstones from active collections
...
### 66. idle armies stagger automatic target scans after their initial acquisition
...
### 67. movement consumes energy and an exhausted unit enters stasis
...
### 68. stasis regenerates only to the reactivation threshold before control returns
...
### 69. active low-energy units passively regenerate an emergency reserve
...
### 70. emergency regeneration lets an energy-starved unit resume firing
...
### 71. every active unit slowly regenerates to 20 percent energy
...
### 72. attacking damages the target and spends the attacker's energy
...
### 73. heavy unit projectiles deal no damage before their visible impact
...
### 74. long-range projectile events remain visible until their delayed impact
...
### 75. ordinary weapons deal reduced damage to aircraft
...
### 76. dedicated anti-air units deal bonus damage to aircraft
...
### 77. flak turrets prioritize aircraft and apply their air damage bonus
...
### 78. Raiders are fast harassment units that deal bonus damage to structures
...
### 79. Raiders automatically prioritize exposed infrastructure
...
### 80. Overdrive is restricted by unit capability and consumes energy
...
### 81. a linked charger draws stored energy from a grid battery
...
### 82. the faster Induction Charger transfers its provisional maximum rate
...
### 83. the enlarged Induction Charger field reaches 260 world units
...
### 84. an Induction Charger charges every unit in its field simultaneously
...
### 85. all units receive the full charger rate when the grid can supply it
...
### 86. every unit type has the enlarged provisional energy capacity
...
### 87. a charger outside the generator network cannot charge units
...
### 88. generators continuously produce and retain a capped internal reserve
...
### 89. battery storage is capped by completed battery capacity
...
### 90. an isolated charged battery powers its local grid while discharging
...
### 91. Crystal Harvesters continuously consume their passive power demand
...
### 92. a charged relay keeps its local grid alive after its generator is destroyed
...
### 93. an active factory queue adds production demand and lowers net energy
...
### 94. destroying a battery removes its stored energy and capacity
...
### 95. an energy carrier automatically supplies allies without crossing its protected reserve
...
### 96. an energy carrier spends exactly the energy shared fairly with nearby units
...
### 97. every mobile energy supplier transfers its matching output rate
...
### 98. every mobile energy supplier carries a tier-improving defensive weapon
...
### 99. destroyed units create finite reclaimable wreckage
...
### 100. a powered salvage yard automatically returns wreck crystal
...
### 101. multiple reclamation drones can harvest the same crystal scrap pile
...
### 102. partially loaded reclamation drones visit another crystal scrap pile before returning
...
### 103. a powered yard replaces a destroyed drone for free after a delay
...
### 104. combat units automatically attack hostile units that enter weapon range
...
### 105. worker drones have weak, short-range defensive weapons
...
### 106. worker drones do not target or retaliate while constructing
...
### 107. worker drones repair damaged friendly units and completed buildings with energy
...
### 108. idle worker drones automatically repair the nearest damaged friendly target
...
### 109. automatic worker repair respects its service radius and higher-priority orders
...
### 110. active construction takes priority over automatic worker repair
...
### 111. worker drones can repair one another but can never repair themselves
...
### 112. an active repair assignment takes priority over worker combat
...
### 113. combat units automatically attack hostile structures in weapon range
...
### 114. player and enemy units pursue the hostile aggressor that damages them
...
### 115. force-moving units do not abandon their order to retaliate
...
### 116. a moving unit stops to attack and resumes its route after the target is destroyed
...
### 117. a force move ignores enemies until the unit reaches its destination
...
### 118. power relay towers extend a generator network to distant structures
...
### 119. power coverage uses the same grid-aligned square cells as network connections
...
### 120. powered Crystal Harvesters generate crystal over time
...
### 121. bright Rich Crystal Deposits increase a harvester's actual crystal output
...
### 122. each mech factory tier offers improved copies of the same six unit roles
...
### 123. vehicle factories produce six matching-tier vehicle roles
...
### 124. air factories begin at Tier 2 and produce six matching-tier aircraft roles
...
### 125. all flying units use the faster movement profiles
...
### 126. Dropships begin at Tier 2 in Air Factories with eight ground-unit cargo slots
...
### 127. explicit transport orders reserve eight slots, board nearby units, and unload them
...
### 128. multi-transport filling balances reservations and rejects aircraft cargo
...
### 129. destroying a loaded Dropship destroys its passengers and snapshots preserve cargo
...
### 130. all units and structures provide a useful deterministic vision range
...
### 131. enemy contacts are hidden until they enter current friendly vision
...
### 132. powered radar arrays reveal long range and lose that coverage off-grid
...
### 133. radar towers and mobile radar units improve across every available branch tier
...
### 134. enemy AI invests in radar after preserving its opening wave and garrison
...
### 135. direct attack commands cannot target unseen enemies
...
### 136. vehicle and air factories only queue units from their own tier and branch
...
### 137. vehicle and air factories deploy their completed production orders
...
### 138. mech factories only queue the six unit variants matching their tier
...
### 139. matching factory groups route production to the shortest powered queue
...
### 140. repeated group production orders distribute across matching factories
...
### 141. group production skips unpowered factories and rejects mixed factory types
...
### 142. a Tier 1 mech factory spends crystal and constructs a worker drone
...
### 143. unit roles and tiers reserve different provisional supply amounts
...
### 144. production reserves supply and rejects orders beyond the massive base limit
...
### 145. a powered Strategic Supply Complex adds and upgrades massive supply capacity
...
### 146. the Strategic Supply Complex is larger than every production building
...
### 147. factories choose an unobstructed exit when the preferred spawn is blocked
...
### 148. factories do not deploy a completed unit on top of another unit
...
### 149. player and enemy factories spread repeated output across rally formations
...
### 150. setting a new factory rally point resets its formation slots
...
### 151. matching factories share an atomic grouped rally point and formation
...
### 152. grouped rally rejects mixed factory types and tiers without changing either
...
### 153. a completed unit waits in a surrounded factory until an exit opens
...
### 154. newly produced combat units engage threats while rallying
...
### 155. workers spend crystal and complete new structures
...
### 156. damage to an unfinished building persists through construction and completion
...
### 157. Shift-queued construction completes foundations in placement order
...
### 158. ordinary build orders replace queued construction and move orders clear it
...
### 159. cancelling construction removes it from worker queues and advances current work
...
### 160. powered sentry turrets automatically defend against nearby enemies
...
### 161. powered sentry turrets automatically attack hostile structures
...
### 162. a sentry capacitor charges from live generator output and fires without a grid battery
...
### 163. a relay-connected sentry capacitor accepts partial surplus generator output
...
### 164. full idle sentries do not prevent a new sentry from charging
...
### 165. workers can build and upgrade every Shield Turret tier
...
### 166. Shield Turret protection radii use the expanded balance values
...
### 167. Shield Turret upgrades retain existing strength and regenerate the added capacity
...
### 168. higher-tier Shield Turrets protect targets beyond the Tier 1 field
...
### 169. a powered Shield Turret absorbs hits inside its field and spills excess damage through
...
### 170. a powered Shield Turret protects its own structure
...
### 171. Shield Turrets do not intercept attacks outside their field or while unpowered
...
### 172. a damaged Shield Turret regenerates slowly by drawing local grid energy
...
### 173. destroyed reclamation drones drop their carried crystal scrap at the death location
...
### 174. both sides start with a Headquarters, three workers, a Tier 1 factory, a generator, and a powered Crystal Harvester
...
### 175. Crystal Harvesters can only be placed on unused crystal deposits and snap to them
...
### 176. energy-production buildings can be placed away from crystal deposits
...
### 177. units route around structures without crossing their collision footprint
...
### 178. a worker can leave the lane after completing a building beside another structure
...
### 179. workers can construct from a corner of a rectangular building footprint
...
### 180. a lower-tier worker cannot resume an advanced foundation
...
### 181. right-click build commands can resume an unfinished friendly structure
...
### 182. a replacement worker can finish a project after the original builder dies
...
### 183. a worker keeps its construction assignment through stasis and resumes after reactivation
...
### 184. construction placement rejects foundations that overlap existing buildings
...
### 185. buildings may occupy directly adjacent grid cells without invisible padding
...
### 186. friendly units vacate a construction site when its foundation is placed
...
### 187. construction placement still rejects sites occupied by hostile units
...
### 188. ordinary buildings snap to the shared 40-unit construction grid
...
### 189. odd and even building footprints align every edge to a grid line
...
### 190. building classes use distinct grid footprints
...
### 191. Crystal Harvester footprints never exceed two grid cells per side
...
### 192. the Tier 2 Power Relay Tower stays compact and improves every relay function
...
### 193. enemy AI searches nearby grid cells when its preferred generator site is occupied
...
### 194. enemy AI construction avoids sites controlled by a superior hostile force
...
### 195. enemy AI remembers recently destroyed construction sites
...
### 196. enemy AI skips a contested deposit for a safer expansion
...
### 197. enemy AI requests generators instead of Grid Batteries at every energy level
...
### 198. enemy AI proactively maintains multiple paid Pulse Generators
...
### 199. enemy AI scales generator count and output headroom with its consumers
...
### 200. advanced AI economies add generators matching their operational tier
...
### 201. enemy AI waits for its pending generator without adding a Grid Battery
...
### 202. enemy AI requests flak when aircraft threaten its base
...
### 203. a stable AI builds vehicle and air production through each available tier
...
### 204. every AI commander independently requests its missing vehicle branch
...
### 205. a mature enemy economy deliberately progresses through Tier 2 and Tier 3 factories
...
### 206. advanced enemy mech factories produce the worker generation needed for the next tier
...
### 207. enemy AI builds at most one charger and only for depleted staged units
...
### 208. enemy AI routes depleted staged units into its charger and waits for recharge
...
### 209. the standard enemy opening establishes defenses and launches promptly
...
### 210. enemy AI builds generation before spending crystal on an unpowered consumer
...
### 211. enemy AI places a needed relay on its connected grid
...
### 212. enemy AI places powered consumers inside its energized grid
...
### 213. enemy AI completes extra generation before projected demand exceeds supply
...
### 214. enemy AI reassigns an idle worker to an abandoned foundation
...
### 215. enemy AI builds an initial combat force before reserving for expensive construction
...
### 216. enemy AI balances combat roles and adds energy support as its army grows
...
### 217. enemy AI never exceeds three mobile energy suppliers across all branches
...
### 218. enemy AI reserves crystal for its next generator after fielding a combat force
...
### 219. enemy AI only constructs a Supply Complex when its remaining supply is low
...
### 220. enemy AI establishes a paid outpost and expands to another crystal deposit
...
### 221. fortified opposition accelerates AI expansion beyond two harvesters
...
### 222. AI strategy requests a sentry at every undefended remote harvester
...
### 223. AI outpost garrisons stay out of attack waves and answer local threats
...
### 224. enemy AI expands beyond four harvesters when crystal is low and skips player claims
...
### 225. workers begin construction at the floating-point edge of build range
...
### 226. enemy combat units wait for a full wave before attacking
...
### 227. enemy AI does not count armed workers as an attack wave
...
### 228. enemy combat units fire at nearby workers while advancing
...
### 229. enemy AI holds an outmatched wave until enough attackers are staged
...
### 230. enemy AI chooses a safer target instead of attacking a defended position
...
### 231. an already dispatched AI assault does not turn around when defenses appear
...
### 232. enemy combat units immediately answer structures rushed near their base as a wave
...
### 233. enemy rush responses wait for a coordinated force instead of sending one unit
...
### 234. cancelling construction removes the foundation, clears workers, and refunds unbuilt crystal
...
### 235. destroying every enemy unit and building ends the match in victory
...
### 236. losing every player unit and building ends the match in defeat
...
### 237. destroying a Headquarters instantly eliminates all of that commander's assets
...
### 238. field tests enable elimination while isolated simulations remain opt-in
...
### 239. multiplayer field tests disable the enemy commander AI
...
### 240. simulation snapshots restore a playable multiplayer client state
...
### 241. mixed human and AI matches continue until only one command team remains
...
### 242. multiplayer lobby codes are exactly ten uppercase letters and numbers
...
### 243. every player count offers multiple dense and selectable battlefield layouts
...
### 244. the three-player ancient ruins map is a dense ruin complex
...
### 245. an eight-player match gives every commander the standard starting package
...
### 246. match teams preserve per-AI difficulty and player-selected alliances
...
### 247. AI difficulty changes deterministic decision cadence and attack preparation
...
### 248. eliminated AI commanders stop running strategic decisions
...
### 249. allied commanders share vision, reject friendly fire, and win together
...
### 250. snapshots preserve AI difficulties and commander alliances
...
### 251. every AI commander makes decisions with independent state and resources
...
### 252. victory waits until every AI commander has been eliminated
...
### 253. snapshots preserve multi-AI teams, starts, maps, and decision state
...
### 254. tactical minimap crystal markers use bright fog-independent colors
...
### 255. mortar shells travel faster and keep tracking moving targets
